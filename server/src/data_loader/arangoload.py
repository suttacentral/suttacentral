...
def load_lzh_reference_edition(file: Path) -> None:
    docs = json_load(file)
    Collection('lzh_reference_edition').recreate(docs)
...
def run(no_pull: bool = False) -> StagePrinter:
    ...
    load_lzh_reference_edition(misc_dir / 'lzh_reference_edition.json')

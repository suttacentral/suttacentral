        ...
        <header>
          ...
          <div>
            <details class="help-display">
              <summary>
                <svg
                  aria-labelledby="help-display-svg-title"
                  role="img"
                  fill="currentColor"
                  ...
                  width="24"
                >
                  <title id="help-display-svg-title">Help</title>
            ...
            <button id="btnClose" @click=${this.hide}>
              <svg
                aria-labelledby="close-display-svg-title"
                role="img"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
                height="24"
              ...
              >
                ...
                <title id="close-display-svg-title">Close</title>
                <path

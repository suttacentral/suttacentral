    ...
    return html`
      ...
      <main>
          ...
          <picture>
            ...
            <img alt="${this.localize('025257a3215157ee4626b3cb6e483c94')}" class="image-home-full" src="/img/static-pages/Life_of_Buddha_Burmese_Manuscript_22_Volume_1_Wellcom.avif" title="${this.localize('d9b4df8b039c324a4b8e7f98426f2455')}" width="640px">
          </picture>
          <h2>
          ...
          <p>
            <picture>
              ...
              <img alt="${this.localize('48b65b4ddc298706957757b9d1084047')}" class="image-home" src="/img/static-pages/dn20.avif" title="${this.localize('4876141d1d5c276e672a3bf35f732208')}" width="640px">
            </picture>

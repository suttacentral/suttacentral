    ...
    return html`
      ...
      <main>
        <article>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:80'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:81'))}</p>
          <h2 id="item5">${this.localize('an-introduction-bodhi:82')}</h2>
          <p>${this.localize('an-introduction-bodhi:83')}</p>
          ...
          <p>${this.localize('an-introduction-bodhi:89')}</p>
          <table>
            <caption>
              ${this.localize('an-introduction-bodhi:90')}
            </caption>
            <tbody>
              <tr>
                <th>${this.localize('an-introduction-bodhi:91')}</th>
                <th>${this.localize('an-introduction-bodhi:51')}</th>
                <th>${this.localize('an-introduction-bodhi:52')}</th>
                <th>${this.localize('an-introduction-bodhi:53')}</th>
                <th>${this.localize('an-introduction-bodhi:54')}</th>
              ...
              <tr>
                <td>${this.localize('an-introduction-bodhi:93')}</td>
                <td>${this.localize('an-introduction-bodhi:94')}</td>
                <td>${this.localize('an-introduction-bodhi:95')}</td>
                <td>${this.localize('an-introduction-bodhi:96')}</td>
                <td>${this.localize('an-introduction-bodhi:97')}</td>
                <td>${this.localize('an-introduction-bodhi:98')}</td>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:121'))}</p>
          <h2 id="item6">${this.localize('an-introduction-bodhi:122')}</h2>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:123'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:124'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:125'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:126'))}</p>
          <h2 id="item7">${this.localize('an-introduction-bodhi:127')}</h2>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:128'))}</p>
          <p>${this.localize('an-introduction-bodhi:129')}</p>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:134'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:135'))}</p>
          <h2 id="item8">${this.localize('an-introduction-bodhi:136')}</h2>
          ...
          <h2 id="item9">${this.localize('an-introduction-bodhi:143')}</h2>
          <p>${this.localize('an-introduction-bodhi:144')}</p>
          ...
          <p>${this.localize('an-introduction-bodhi:149')}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:150'))}</p>
          <h2 id="item10">${this.localize('an-introduction-bodhi:151')}</h2>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:158'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:159'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:160'))}</p>
          <h2 id="item11">${this.localize('an-introduction-bodhi:161')}</h2>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:168'))}</p>
          ...
          <h2 id="item12">${this.localize('an-introduction-bodhi:172')}</h2>
          <p>${this.localize('an-introduction-bodhi:173')}</p>
          <p>${this.localize('an-introduction-bodhi:174')}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:175'))}</p>
          <h2 id="item13">${this.localize('an-introduction-bodhi:176')}</h2>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:177'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:178'))}</p>
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:179'))}</p>
          ...
          <p>${unsafeHTML(this.localize('an-introduction-bodhi:183'))}</p>
          <aside class="static-copyright">
            <p>${this.localize('an-introduction-bodhi:184')}</p>
            <blockquote>
              <p>${this.localize('an-introduction-bodhi:185')}</p>
              <p>${this.localize('an-introduction-bodhi:186')}</p>
            </blockquote>
          </aside>
        </article>
      </main>

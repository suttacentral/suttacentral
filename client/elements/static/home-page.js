  ...
  render() {
    ...
    <div class="bottom-space" id="page-wrap">
      <div class="content">
        ...
        <div class="row cards">
          <paper-card class="two-paper-cards paper-cards-no-background first-card transparent-card" elevation="2" image="/img/home-page/returninghome.jpg" alt="${this.localize('742e700832d62bb2f6a17592968b4dab')}">
          ...
          <paper-card class="two-paper-cards paper-cards-no-background second-card transparent-card" elevation="2" image="/img/home-page/contemplatingthemoon.jpg" alt="${this.localize('a5172cf2c34de3fc8e2af331ac915ec9')}">
            <div class="transparent-card-content-wrapper">
              <div class="card-title-text">
        ...
        <div class="row cards">
          <paper-card class="two-paper-cards first-card paper-card-with-button" elevation="2" image="/img/home-page/noword.jpg" alt="${this.localize('078365b3da2eb8b34d23c36661309359')}">
          ...
          <paper-card class="two-paper-cards second-card paper-card-with-button" elevation="2" image="/img/home-page/listeningtotherain.jpg" alt="${this.localize('149842aa5477edb219ce272ec2aab269')}">
            <div class="card-content-wrapper">
              <div class="card-title-text">

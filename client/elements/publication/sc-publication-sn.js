...
class ScPublicationSn extends LitLocalized(LitElement) {
  static get styles() {
    return css`
      ${SCPublicationStyles}
      :host {
  ...
  firstUpdated() {
    this._updateNav();
    reduxActions.changeToolbarTitle('Publications-Linked Discourses');
  }
  ...
  _updateNav() {
    ...
    navArray.length = 2;
    navArray.push({
      title: 'Publications-Linked Discourses',
      url: `${currentPath}`,
      ...
      <main>
        <article>
          <header class="page-header">
            <h1>Linked Discourses</h1>
            <p class="subtitle">A translation of the Saṁyutta Nikāya</p>
          ...
          <nav class="toc">
            <ol>
              ...
              <li><a href="#heading2">The Saṁyutta Nikāya</a></li>
          ...
          <section class="description">
            ...
            <h2><a id="heading2">The Saṁyutta Nikāya</a></h2>
            <p class="blurb">
...
customElements.define('sc-publication-sn', ScPublicationSn);
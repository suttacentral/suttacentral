...
class ScPublicationDn extends LitLocalized(LitElement) {
  static get styles() {
    return css`
      ${SCPublicationStyles}
      :host {
  ...
  firstUpdated() {
    this._updateNav();
    reduxActions.changeToolbarTitle('Publications-Long Discourses');
  }
  ...
  _updateNav() {
    ...
    navArray.length = 2;
    navArray.push({
      title: 'Publications-Long Discourses',
      url: `${currentPath}`,
      ...
      <main>
        <article>
          <header class="page-header">
            ...
            <p class="subtitle">A translation of the Dīgha Nikāya</p>
          ...
          <nav class="toc">
            <ol>
              ...
              <li><a href="#heading2">The Dīgha Nikāya</a></li>
...
customElements.define('sc-publication-dn', ScPublicationDn);

        ...
        <section>
          ...
          <nav class="contents">
            <ol>
              ...
              <li>
                ${_`<a href="#item2">Transmission</a>`}
              </li>
              <li>
                ${_`<a href="#item3">The Early Schools of Buddhism</a>`}
              </li>
              <li>
                ${_`<a href="#item4">Structure</a>`}
              </li>
              <li>
                ${_`<a href="#item5">Canonicity of the Suttas</a>`}
              </li>
              <li>
                ${_`<a href="#item6">Suttas in the Buddhist Traditions</a>`}
              </li>
              <li>
                ${_`<a href="#item7">Modern Reform and Postmodern Criticism</a>`}
              </li>
              <li>
                ${_`<a href="#item8">Translations</a>`}
              </li>
            </ol>
          </nav>
          <p>
          ...
          <h2 id="item3">
            ${_`The Early Schools of Buddhism`}
          </h2>
          <p>
          ...
          <h2 id="item6">
            ${_`Suttas in the Buddhist Traditions`}
          </h2>
          <p>
          ...
          <h2 id="item7">
            ${_`Modern Reform and Postmodern Criticism`}
          </h2>
          <p>

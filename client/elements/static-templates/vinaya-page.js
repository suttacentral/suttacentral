      ...
      <main>
        <section>
          ...
          <nav class="contents">
            <ol>
              <li>
                ${_`<a href="#item1">Origin</a>`}
              </li>
              <li>
                ${_`<a href="#item2">Textual Transmission and the Schools</a>`}
              </li>
              <li>
                ${_`<a href="#item3">Content</a>`}
              </li>
              <li>
                ${_`<a href="#item4">Modern Perspectives</a>`}
              </li>
              <li>
                ${_`<a href="#item5">Commentaries</a>`}
              </li>
              <li>
                ${_`<a href="#item6">References and Further Reading</a>`}
              </li>
            </ol>
          </nav>
          <p>
          ...
          <h2 id="item2">
            ${_`Textual Transmission and the Schools`}
          </h2>
          <p>
          ...
          <h2 id="item6">
            ${_`References and Further Reading`}
          </h2>
          <ul>
            <li>
            ...
            <li>
              ${_`Sujato, Bhikkhu; <cite>Sects and Sectarianism</cite>; Santipada, 2012`}
            </li>
            <li>
              ${_`Sujato, Bhikkhu; <cite>Bhikkhunī Vinaya Studies</cite>; Santipada, 2009`}
            </li>
          </ul>
        </section>
      </main>

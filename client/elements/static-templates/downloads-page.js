        ...
        <main>
          <section>
            <article>
              ...
              <p>${_`The latest version of key translations on SuttaCentral.</p>`}</p>
              <ul>
                <li>
              ...
              <h2>${_`The Book of the Discipline`}</h2>
              <p>
              ...
              <h2>${_`Sutta Nipāta by Laurence Mills`}</h2>
              <p>

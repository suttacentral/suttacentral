            ...
            <article>
              ...
              <nav class="contents">
                <ol>
                  ...
                  <li>${_`<a href="#item2">The Books of the Theravāda Abhidhamma </a>`}</li>
                  <li>${_`<a href="#item3">The Books of the Sarvāstivāda Abhidhamma </a>`}</li>
                  <li>${_`<a href="#item4">The Dharmaguptaka Śāripūtrābhidharma </a>`}</li>
                  <li>${_`<a href="#item5">Abhidhamma in Buddhist Traditions </a>`}</li>
                  <li>${_`<a href="#item6">Criticism</a>`}</li>
                </ol>
              </nav>
              <p>
              ...
              <h2 id="item2">${_`The Books of the Theravāda Abhidhamma`}</h2>
              <p>
              ...
              <ol>
                ...
                <li>${_`Catechism: tests the student’s knowledge with systematic questioning.`}</li>
              </ol>
              <p>
              ...
              <h2 id="item3">${_`The Books of the Sarvāstivāda Abhidhamma`}</h2>
              <p>
              ...
              <p>${_`The originals of all these Sarvāstivāda works were in Sanskrit.`}</p>
              <h3>${_`Saṅgītiparyāya`}</h3>
              <p>
              ...
              <h2 id="item4">${_`The Dharmaguptaka Śāripūtrābhidharma`}</h2>
              <p>
              ...
              <h2 id="item5">${_`Abhidhamma in Buddhist Traditions`}</h2>
              <p>

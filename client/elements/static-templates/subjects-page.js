          ...
          <section>
            <article>
              ...
              <ul>
                ...
                <li>${_`HTML structure is modified.`}</li>
                <li>${_`Diacritical marks have added.`}</li>
                <li>${_`Links go to SuttaCentral.`}</li>
                <li>
              ...
              <p>${_`The caveat expressed by the author of the original index still apply:`}</p>
              <blockquote>
              ...
              <p>${_`In addition, note the following:`}</p>
              <ul>
                <li>${_`References only include the Pali texts.`}</li>
                <li>${_`A tilde (~) stands for the head-word in a given entry.`}</li>
              </ul>
              <nav class="contents">
                <ul class="entry-list">
                  <li>${_`<a href="#a">A</a>`}</li>
                  <li>${_`<a href="#b">B</a>`}</li>
                  <li>${_`<a href="#c">C</a>`}</li>
                  <li>${_`<a href="#d">D</a>`}</li>
                  <li>${_`<a href="#e">E</a>`}</li>
                  <li>${_`<a href="#f">F</a>`}</li>
                  <li>${_`<a href="#g">G</a>`}</li>
                  <li>${_`<a href="#h">H</a>`}</li>
                  <li>${_`<a href="#i">I</a>`}</li>
                  <li>${_`<a href="#j">J</a>`}</li>
                  <li>${_`<a href="#k">K</a>`}</li>
                  <li>${_`<a href="#l">L</a>`}</li>
                  <li>${_`<a href="#m">M</a>`}</li>
                  <li>${_`<a href="#n">N</a>`}</li>
                  <li>${_`<a href="#o">O</a>`}</li>
                  <li>${_`<a href="#p">P</a>`}</li>
                  <li>${_`<a href="#qq">Q</a>`}</li>
                  <li>${_`<a href="#r">R</a>`}</li>
                  <li>${_`<a href="#s">S</a>`}</li>
                  <li>${_`<a href="#t">T</a>`}</li>
                  <li>${_`<a href="#u">U</a>`}</li>
                  <li>${_`<a href="#v">V</a>`}</li>
                  <li>${_`<a href="#w">W</a>`}</li>
                  <li>${_`<a href="#xyz">XYZ</a>`}</li>
                </ul>
              </nav>
              <h2 id="a">${_`A`}</h2>
              <dl>
                <dt id="adhitthana">${_`Adhiṭṭhāna`}</dt>
                <dd class="description">
                  ${_`<span class="translation">determination, resolution</span>`}
                </dd>
                <dd>${_`Four determinations: <a class="ref" href="/mn140">MN 140</a>`}</dd>
                <dt id="adinava">${_`Ādīnava`}</dt>
                <dd class="description">
                  ${_`<span class="translation">drawbacks, dangers</span>. See also <a href="#gradual">Gradual instruction</a>.`}
                </dd>
                <dd>${_`~ of feeling: <a class="ref" href="/mn13">MN 13</a>`}</dd>
                <dd>${_`~ of form: <a class="ref" href="/mn13">MN 13</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ of clingable phenomena: <a class="ref" href="/sn12.52">SN 12.52</a>`}</dd>
                <dd>
                  ${_`~ of aging, illness, and death: <a class="ref" href="/an3.62">AN 3.62</a>, <a class="ref" href="/an4.252">AN 4.252</a>`}
                </dd>
                <dd>${_`~ of supranormal powers: <a class="ref" href="/dn11">DN 11</a>`}</dd>
                <dd>${_`~ of unskillful thoughts: <a class="ref" href="/mn20">MN 20</a>`}</dd>
                <dd>${_`~ of unskillful conduct: <a class="ref" href="/an2.18">AN 2.18</a>`}</dd>
                <dd>
                  ${_`As one of ten perceptions: <a class="ref" href="/an10.60">AN 10.60</a>`}
                </dd>
                <dt>${_`Admonishment`}</dt>
                <dd class="description">${_`See also <a href="#speech">Speech</a>.`}</dd>
                <dd>
                ...
                <dt id="aging">${_`Aging`}</dt>
                <dd class="description">
                  ${_`See also <a href="#death">Death</a>; <a href="#divine">Divine messengers</a>; <a href="#illness">Illness</a>; four noble truths.`}
                </dd>
                <dd>${_`The Buddha spits on ~: <a class="ref" href="/sn48.41">SN 48.41</a>`}</dd>
                <dd>${_`Description of ~: <a class="ref" href="/mn9">MN 9</a>`}</dd>
                <dd>
                ...
                <dd>${_`Age is no measure of wisdom: <a class="ref" href="/sn3.1">SN 3.1</a>`}</dd>
                <dd>
                  ${_`Advice to two aging brahmans: <a class="ref" href="/an3.51">AN 3.51</a>, <a class="ref" href="/an3.52">AN 3.52</a>`}
                </dd>
                <dt id="anapanasati">${_`Ānāpānassati`}</dt>
                <dd class="description">
                ...
                <dd>${_`How ~ leads to Awakening: <a class="ref" href="/sn54.13">SN 54.13</a>`}</dd>
                <dd>
                ...
                <dd>${_`As a method of subduing lust: <a class="ref" href="/sn8.4">SN 8.4</a>`}</dd>
                <dd>
                ...
                <dd>${_`Ponder ~ constantly: <a class="ref" href="/thag1.111">Thag 1.111</a>`}</dd>
                <dd>
                ...
                <dt id="apaya-mukha">${_`Apāya-mukha`}</dt>
                <dd class="description">
                ...
                <dd>${_`Benefits of ~: <a class="ref" href="/iti23">Iti 23</a>`}</dd>
                <dd>${_`Wake up!: <a class="ref" href="/snp2.10">Snp 2.10</a>`}</dd>
                <dt>${_`Appropriate attention`}</dt>
                <dd class="description">${_`See <a href="#yoniso">Yoniso-manasikāra</a>.`}</dd>
                <dt id="arahant">${_`Arahant`}</dt>
                <dd class="description">
                ...
                <dd>${_`Who can find fault in an ~? <a class="ref" href="/ud7.6">Ud 7.6</a>`}</dd>
                <dd>
                ...
                <dd>${_`Does an ~ grieve? <a class="ref" href="/sn21.2">SN 21.2</a>`}</dd>
                <dd>
                ...
                <dd>${_`“Arahants” (Dhammapada chapter 7)`}</dd>
                <dd>${_`“Brahmans” (Dhammapada chapter 26)`}</dd>
                <dd>
                ...
                <dt>${_`Ariya-aṭṭhaṅgika-magga`}</dt>
                <dd class="description">
                  ${_`See <a href="#eightfold">Noble Eightfold Path</a>.`}
                </dd>
                <dt>${_`Ariya-sacca`}</dt>
                <dd class="description">${_`See <a href="#fourtruths">Four Noble Truths</a>.`}</dd>
                <dt id="asava">${_`Āsava`}</dt>
                <dd class="description">
                ...
                <dd>${_`~ and right view: <a class="ref" href="/mn117">MN 117</a>`}</dd>
                <dd>
                  ${_`Six important aspects of ~ to be understood: <a class="ref" href="/an6.63">AN 6.63</a>`}
                </dd>
                <dt id="ascetic">${_`Ascetic practices`}</dt>
                <dd>${_`Thirteen ~: <a class="ref" href="/thag16.7">Thag 16.7</a>`}</dd>
                <dd>
                ...
                <dt id="attachment">${_`Attachment`}</dt>
                <dd class="description">
                ...
                <dt id="attha-sila">${_`Aṭṭha-sīla`}</dt>
                <dd class="description">
                  ${_`<span class="translation">the eight precepts</span>. See <a href="#precepts">Precepts</a>.`}
                </dd>
                <dt id="aversion">${_`Aversion`}</dt>
                <dd class="description">${_`See <a href="#ill">Ill-will</a> (vyāpāda).`}</dd>
                <dt id="avijja">${_`Avijjā`}</dt>
                <dd class="description">
                ...
                <dd>${_`As a flood: <a class="ref" href="/sn45.171">SN 45.171</a>`}</dd>
                <dd>${_`As a yoke: <a class="ref" href="/an4.10">AN 4.10</a>`}</dd>
                <dd>
                ...
                <dd>${_`As an obstruction: <a class="ref" href="/iti14">Iti 14</a>`}</dd>
                <dt id="awakening">${_`Awakening`}</dt>
                <dd class="description">
                  ${_`See also <a href="#nibbana">Nibbāna</a>; <a href="#vimutti">Vimutti</a> (release).`}
                </dd>
                <dd>${_`Factors for ~: see <a href="#bojjhanga">Bojjhaṅga</a>.`}</dd>
                <dd>${_`Is ~ “gradual” or “sudden”? <a class="ref" href="/ud5.5">Ud 5.5</a>`}</dd>
                <dt id="awareness">${_`Awareness`}</dt>
                <dd class="description">${_`See <a href="#sati">Sati</a>.`}</dd>
                <dt id="ayoniso">${_`Ayoniso manasikāra (inappropriate attention)`}</dt>
                <dd class="description">
              ...
              <dl>
                ...
                <dd>${_`Definition of the ~: <a class="ref" href="/an5.2">AN 5.2</a>`}</dd>
                <dt id="beauty">${_`Beauty`}</dt>
                <dd>
                  ${_`As a meditative attainment: <a class="ref" href="/sn14.11">SN 14.11</a>`}
                </dd>
                <dt id="bhava">${_`Bhava`}</dt>
                <dd class="description">
                ...
                <dt>${_`Bhikkhu (monk)`}</dt>
                <dd class="description">${_`See <a href="#monastic">Monastic Life</a>.`}</dd>
                <dt>${_`Bhikkhunī (nun)`}</dt>
                <dd class="description">${_`See <a href="#monastic">Monastic Life</a>.`}</dd>
                <dd>${_`The Therīgāthā (Thig) is a collection of verses by nuns.`}</dd>
                <dd>
                  ${_`The Bhikkhunī Saṁyutta (<a class="ref" href="/sn5">SN 5</a>) is another collection with verses by nuns.`}
                </dd>
                <dt>${_`Birth`}</dt>
                <dd class="description">${_`See <a href="#jati">Jāti</a>.`}</dd>
                <dt id="bodhipakkhiya-dhamma">${_`Bodhipakkhiya-dhamma`}</dt>
                <dd class="description">
                ...
                <dt>${_`Also look under each of its constituent seven sets:`}</dt>
                <dd>
                  ${_`<a href="#satipatthana">Satipaṭṭhāna</a> (4 kinds of mindfulness meditation);`}
                </dd>
                <dd>${_`<a href="#sammappadhana">Sammāppadhāna</a> (4 right efforts);`}</dd>
                <dd>${_`<a href="#iddhipada">Iddhipada</a> (4 bases of psychic power);`}</dd>
                <dd>${_`<a href="#indriya">Indriya</a> (5 faculties);`}</dd>
                <dd>${_`<a href="#bala">Bala</a> (5 powers);`}</dd>
                <dd>${_`<a href="#bojjhanga">Bojjhaṅga</a> (7 awakening factors);`}</dd>
                <dd>${_`<a href="#eightfold">Noble Eightfold Path</a>.`}</dd>
                <dt id="body">${_`Body`}</dt>
                <dd class="description">
                  ${_`See also <a href="#asubha">Asubha</a>; <a href="#attachment">Attachment</a>; <a href="#sensuality">Sensuality</a>.`}
                </dd>
                <dd>${_`Mindfulness of the ~: see <a href="#satipatthana">Satipaṭṭhāna</a>.`}</dd>
                <dd>${_`Thirty-one parts of the ~: <a class="ref" href="/mn10">MN 10</a>`}</dd>
                <dd>
                ...
                <dt id="bojjhanga">${_`Bojjhaṅga`}</dt>
                <dd class="description">
                ...
                <dd>${_`See the suttas in the Bojjhaṅga-saṁyutta of the Saṁyutta Nikāya`}</dd>
                <dt id="brahmavihara">${_`Brahmavihāra`}</dt>
                <dd class="description">
                ...
                <dt>${_`Breath meditation`}</dt>
                <dd class="description">${_`See <a href="#anapanasati">Ānāpānassati</a>.`}</dd>
                <dt id="buddha">${_`Buddha`}</dt>
                <dd class="description">${_`See also <a href="#arahant">Arahant</a>.`}</dd>
                <dd>
                  ${_`As one of the ten Recollections: see <a href="#recollections">Recollections, ten</a>.`}
                </dd>
                <dd>
              ...
              <dl>
                ...
                <dd>${_`A bhikkhu has no caste: <a class="ref" href="/an10.48">AN 10.48</a>`}</dd>
                <dt id="celibacy">${_`Celibacy`}</dt>
                <dd class="description">
                ...
                <dt>${_`Ceremonies`}</dt>
                <dd class="description">${_`See <a href="#rituals">Rituals</a>.`}</dd>
                <dt id="chanting">${_`Characteristics of existence`}</dt>
                <dd class="description">${_`See <a href="#tilakkhana">Tilakkhaṇa</a>.`}</dd>
                <dt id="children">${_`Children`}</dt>
                <dd class="description">
                ...
                <dd>${_`Parents’ duties to their ~: <a class="ref" href="/dn31">DN 31</a>`}</dd>
                <dt>${_`Clinging`}</dt>
                <dd class="description">${_`See <a href="#upadana">Upādāna</a>.`}</dd>
                <dt id="communal">${_`Communal harmony`}</dt>
                <dd class="description">
                ...
                <dt id="comparative">${_`Comparative Religions`}</dt>
                <dd class="description">${_`See also <a href="#god">God</a>.`}</dd>
                <dd>
                ...
                <dt>${_`Compassion`}</dt>
                <dd class="description">${_`See <a href="#karuna">Karuṇā</a>.`}</dd>
                <dt>${_`Conceit`}</dt>
                <dd class="description">${_`See <a href="#mana">Māna</a>.`}</dd>
                <dt>${_`Concentration`}</dt>
                <dd class="description">${_`See <a href="#samadhi">Samādhi</a>.`}</dd>
                <dt id="conflict">${_`Conflict`}</dt>
                <dd class="description">
                ...
                <dt>${_`Conscience`}</dt>
                <dd class="description">${_`See <a href="#hiri">Hiri</a>.`}</dd>
                <dt>${_`Consciousness`}</dt>
                <dd class="description">${_`See <a href="#vinnana">Viññāṇa</a>.`}</dd>
                <dt>${_`Contact`}</dt>
                <dd class="description">${_`See <a href="#phassa">Phassa</a>.`}</dd>
                <dt id="contentment">${_`Contentment with little`}</dt>
                <dd class="description">${_`See also <a href="#restraint">Restraint</a>.`}</dd>
                <dd>
                ...
                <dt>${_`Conviction`}</dt>
                <dd class="description">${_`See <a href="#saddha">Saddhā</a>.`}</dd>
                <dt>${_`Craving`}</dt>
                <dd class="description">${_`See <a href="#tanha">Taṇhā</a>.`}</dd>
                <dt>${_`Creation (of universe)`}</dt>
                <dd class="description">
              ...
              <dl>
                ...
                <dd>${_`As a treasure: <a class="ref" href="/an7.6">AN 7.6</a>`}</dd>
                <dd>
                  ${_`As one of the ten Recollections: see <a href="#recollections">Recollections, ten</a>.`}
                </dd>
                <dd>
                ...
                <dd>${_`Giving even one’s last meal: <a class="ref" href="/iti26">Iti 26</a>`}</dd>
                <dd>
                ...
                <dd>${_`The scale of good deeds: <a class="ref" href="/an9.20">AN 9.20</a>`}</dd>
                <dd>${_`See the suttas in the Devatā-saṁyutta of the Saṁyutta Nikāya`}</dd>
                <dt id="dasasila">${_`Dasa-sīla`}</dt>
                <dd class="description">
                  ${_`<span class="translation">the ten precepts</span>. See <a href="#sila">Sīla</a> (ethics, morality).`}
                </dd>
                <dt id="death">${_`Death`}</dt>
                <dd class="description">
                ...
                <dd>${_`Heedlessness leads one to ~: <a class="ref" href="/dhp21">Dhp 21</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ of daughter: <a class="ref" href="/thig3.5">Thig 3.5</a>`}</dd>
                <dd>${_`~ of grandson: <a class="ref" href="/ud8.8">Ud 8.8</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ of spouse: <a class="ref" href="/an5.49">AN 5.49</a>`}</dd>
                <dd>
                ...
                <dt id="deathless">${_`Deathless`}</dt>
                <dd class="description">
                ...
                <dt>${_`Defilements`}</dt>
                <dd class="description">${_`See <a href="#kilesa">Kilesa</a>.`}</dd>
                <dt>${_`Dependent origination`}</dt>
                <dd class="description">${_`See <a href="#ps">Paṭicca-samuppāda</a>.`}</dd>
                <dt id="desire">${_`Desire`}</dt>
                <dd class="description">${_`as part of the Path (<i>dhamma-chanda</i>)`}</dd>
                <dd>
                ...
                <dd>${_`~ ties down the world: <a class="ref" href="/sn1.69">SN 1.69</a>`}</dd>
                <dd>
                ...
                <dt id="dhamma">${_`Dhamma`}</dt>
                <dd class="description">
                  ${_`See also <a href="#teaching">Teaching the Dhamma</a>.`}
                </dd>
                <dd>${_`Basic principles: <a class="ref" href="/an8.53">AN 8.53</a>`}</dd>
                <dd>
                  ${_`Five rewards of listening to ~: <a class="ref" href="/an5.202">AN 5.202</a>`}
                </dd>
                <dd>${_`How to listen to the ~: <a class="ref" href="/an6.88">AN 6.88</a>`}</dd>
                <dd>
                  ${_`As one of the ten Recollections: see <a href="#recollections">Recollections, ten</a>.`}
                </dd>
                <dt id="dhana">${_`Dhana`}</dt>
                <dd class="description">
                  ${_`<span class="translation">treasures</span>. See also <a href="#wealth">Wealth</a>.`}
                </dd>
                <dd>${_`Buddha, Dhamma, and Saṅgha: <a class="ref" href="/kp6">Kp 6</a>`}</dd>
                <dd>${_`Seven ~: <a class="ref" href="/an7.7">AN 7.7</a>`}</dd>
                <dt id="dhatu">${_`Dhātu`}</dt>
                <dd class="description">
                ...
                <dt>${_`Discernment`}</dt>
                <dd class="description">${_`See <a href="#panna">Paññā</a>.`}</dd>
                <dt>${_`Disenchantment`}</dt>
                <dd class="description">${_`See <a href="#nibbida">Nibbidā</a>.`}</dd>
                <dt id="ditthi">${_`Diṭṭhi`}</dt>
                <dd class="description">
                ...
                <dd>${_`What is wrong ~? <a class="ref" href="/mn117">MN 117</a>`}</dd>
                <dd>
                ...
                <dt id="downfall">${_`Downfall`}</dt>
                <dd>${_`Causes of ~: <a class="ref" href="/snp1.6">Snp 1.6</a>`}</dd>
                <dt>${_`Drawbacks`}</dt>
                <dd class="description">${_`See <a href="#adinava">Ādīnava</a>.`}</dd>
                <dt>${_`Dread (moral)`}</dt>
                <dd class="description">${_`See <a href="#ottappa">Ottappa</a>.`}</dd>
                <dt id="dreams">${_`Dreams`}</dt>
                <dd>
                  ${_`Five ~ that appeared to the Buddha: <a class="ref" href="/an5.196">AN 5.196</a>`}
                </dd>
                <dd>${_`How to ensure good ~: <a class="ref" href="/an11.16">AN 11.16</a>`}</dd>
                <dd>
                  ${_`Interpretation of ~ as a form of wrong livelihood for monks: <a class="ref" href="/dn2">DN 2</a>, <a class="ref" href="/dn11">DN 11</a>`}
                </dd>
                <dt>${_`Drowsiness`}</dt>
                <dd class="description">${_`See <a href="#laziness">Laziness</a>.`}</dd>
                <dt id="dukkha">${_`Dukkha`}</dt>
                <dd class="description">
              ...
              <dl>
                <dt>${_`Ecology`}</dt>
                <dd class="description">${_`See <a href="#nature">Nature</a>.`}</dd>
                <dt>${_`Defilements`}</dt>
                <dd class="description">${_`See <a href="#asava">Āsava</a>.`}</dd>
                <dt>${_`Effort`}</dt>
                <dd class="description">${_`See <a href="#viriya">Viriya</a>.`}</dd>
                <dt>${_`Eightfold Path`}</dt>
                <dd class="description">
                  ${_`See <a href="#eightfold">Noble Eightfold Path</a>.`}
                </dd>
                <dt id="emotion">${_`Emotion`}</dt>
                <dd class="description">
                  ${_`See also <a href="#pasada">Pasāda</a>; <a href="#psychology">Psychology</a>; <a href="#samvega">Saṁvega</a>; <a href="#vedana">Vedanā</a>.`}
                </dd>
                <dd>${_`The source of ~: <a class="ref" href="/mn137">MN 137</a>`}</dd>
                <dt id="emptiness">${_`Emptiness`}</dt>
                <dd class="description">${_`<span class="translation">Suññatā</span>`}</dd>
                <dd>
                ...
                <dt id="engaged">${_`Engaged Buddhism`}</dt>
                <dd class="description">${_`See <a href="#social">Social action</a>.`}</dd>
                <dt>${_`Equanimity`}</dt>
                <dd class="description">${_`See <a href="#upekkha">Upekkhā</a>.`}</dd>
                <dt>${_`Ethics`}</dt>
                <dd class="description">${_`See <a href="#sila">Sīla</a>.`}</dd>
              </dl>
              <h2 id="f">${_`F`}</h2>
              <dl>
                <dt>${_`Faculties, five mental`}</dt>
                <dd class="description">${_`See <a href="#indriya">Indriya</a>.`}</dd>
                <dt>${_`Faith`}</dt>
                <dd class="description">${_`See <a href="#saddha">Saddhā</a>.`}</dd>
                <dt id="family">${_`Family`}</dt>
                <dd class="description">
                ...
                <dd>${_`Causes of a ~’s downfall: <a class="ref" href="/sn42.9">SN 42.9</a>`}</dd>
                <dt id="fear">${_`Fear`}</dt>
                <dd class="description">${_`See also <a href="#death">Death</a>.`}</dd>
                <dd>
                ...
                <dt>${_`Feeling`}</dt>
                <dd class="description">${_`See <a href="#vedana">Vedanā</a>.`}</dd>
                <dt>${_`Fermentations`}</dt>
                <dd class="description">${_`See <a href="#asava">Āsava</a>.`}</dd>
                <dt>${_`Fire imagery`}</dt>
                <dd class="description">
                ...
                <dd>${_`The Fire Sermon: <a class="ref" href="/sn35.28">SN 35.28</a>`}</dd>
                <dd>
                ...
                <dt id="fool">${_`Fool`}</dt>
                <dd class="description">${_`See <a href="#wiseperson">Wise person</a>.`}</dd>
                <dt id="food">${_`Food`}</dt>
                <dd class="description">
                ...
                <dt id="forest">${_`Forest traditions`}</dt>
                <dd class="description">${_`See also <a href="#wilderness">Wilderness</a>.`}</dd>
                <dt>${_`Forgiveness`}</dt>
                <dd class="description">${_`See <a href="#reconciliation">Reconciliation</a>.`}</dd>
                <dt id="fourtruths">${_`The Four Noble Truths`}</dt>
                <dd class="description">
                ...
                <dt>${_`Friendship (admirable)`}</dt>
                <dd class="description">${_`See <a href="#k">Kalyanamittata</a>.`}</dd>
              </dl>
              <h2 id="g">${_`G`}</h2>
              <dl>
                <dt>${_`Generosity`}</dt>
                <dd class="description">${_`See <a href="#dana">Dāna</a>.`}</dd>
                <dt>${_`Giving`}</dt>
                <dd class="description">${_`See <a href="#dana">Dāna</a>.`}</dd>
                <dt>${_`Goal of Buddhist practice`}</dt>
                <dd class="description">${_`See <a href="#nibbana">Nibbāna</a>.`}</dd>
                <dt id="god">${_`God`}</dt>
                <dd class="description">
                ...
                <dt>${_`Goodwill`}</dt>
                <dd class="description">${_`See <a href="#metta">Mettā</a>.`}</dd>
                <dt>${_`Goodness`}</dt>
                <dd class="description">${_`See <a href="#punna">Puñña</a> (merit).`}</dd>
                <dt id="gradual">${_`Gradual instruction`}</dt>
                <dd class="description">${_`<span class="translation">anupubbi-kathā</span>`}</dd>
                <dd>${_`Mentioned in: <a class="ref" href="/ud5.3">Ud 5.3</a>`}</dd>
                <dd>
                ...
                <dt id="gradual_training">${_`Gradual training`}</dt>
                <dd class="description">${_`<span class="translation">anupubba-sikkhā</span>`}</dd>
                <dd>
                  ${_`<a class="ref" href="/dn2">DN 2</a>, <a class="ref" href="/mn107.">MN 107.</a>`}
                </dd>
                <dt id="gratitude">${_`Gratitude`}</dt>
                <dd class="description">
                ...
                <dt id="grief">${_`Grief`}</dt>
                <dd class="description">${_`See also <a href="#death">Death</a>.`}</dd>
                <dd>
                  ${_`How to move beyond obsessive grieving: <a class="ref" href="/an5.49">AN 5.49</a>`}
                </dd>
                <dd>${_`Do arahants grieve? <a class="ref" href="/sn21.2">SN 21.2</a>`}</dd>
                <dd>
                  ${_`Death and loss are inevitable, but is ~? <a class="ref" href="/snp3.8">Snp 3.8</a>`}
                </dd>
                <dt>${_`Guilt`}</dt>
                <dd class="description">${_`See <a href="#hiri">Hiri</a> (moral conscience).`}</dd>
              </dl>
              <h2 id="h">${_`H`}</h2>
              <dl>
                <dt>${_`Habitual patterns of thought`}</dt>
                <dd>${_`Stopping of ~: <a class="ref" href="/mn19">MN 19</a>`}</dd>
                <dt id="happiness">${_`Happiness`}</dt>
                <dd class="description">${_`See also <a href="#vedana">Vedanā</a> (feeling).`}</dd>
                <dd>
                ...
                <dt>${_`Harmlessness`}</dt>
                <dd class="description">${_`See <a href="#ahimsa">Non-harming</a>.`}</dd>
                <dt>${_`Hatred`}</dt>
                <dd class="description">${_`See <a href="#ill">Ill-will</a> (<i>vyāpāda</i>).`}</dd>
                <dt>${_`Headache`}</dt>
                <dd>${_`Ven. Sāriputta’s “slight” ~ <a class="ref" href="/ud4.4">Ud 4.4</a>`}</dd>
                <dt>${_`Heaven realms`}</dt>
                <dd class="description">${_`See <a href="#sagga">Sagga</a>.`}</dd>
                <dt>${_`Heedfulness`}</dt>
                <dd class="description">${_`See <a href="#appamada">Appamāda</a>.`}</dd>
                <dt id="hell">${_`Hell`}</dt>
                <dd class="description">
                ...
                <dd>${_`“Hell” (Dhammapada chapter 12)`}</dd>
                <dd>
                  ${_`Five grave deeds that lead to rebirth in ~: <a class="ref" href="/an5.129">AN 5.129</a>`}
                </dd>
                <dd>${_`Causes of rebirth in ~: <a class="ref" href="/iti70">Iti 70</a>`}</dd>
                <dt>${_`Hindrances`}</dt>
                <dd class="description">${_`See <a href="#nivarana">Nīvaraṇa</a>.`}</dd>
                <dt id="hiri">${_`Hiri`}</dt>
                <dd class="description">
                ...
                <dd>${_`As a rare and fine quality: <a class="ref" href="/sn1.18">SN 1.18</a>`}</dd>
                <dd>${_`As a treasure: <a class="ref" href="/an7.6">AN 7.6</a>`}</dd>
                <dd>${_`As a guardian: <a class="ref" href="/an2.9">AN 2.9</a>`}</dd>
                <dd>
                  ${_`Associated with skillful qualities: <a class="ref" href="/iti40">Iti 40</a>`}
                </dd>
                <dt>${_`Holidays`}</dt>
                <dd class="description">${_`See <a href="#uposatha">Uposatha days</a>.`}</dd>
                <dt id="householder">${_`Householders`}</dt>
                <dd class="description">
                ...
                <dt id="humility">${_`Humility`}</dt>
                <dd class="description">${_`See also <a href="#integrity">Integrity</a>.`}</dd>
                <dd>
                  ${_`As one of the greatest protections/blessings: <a class="ref" href="/snp2.4">Snp 2.4</a>`}
                </dd>
              </dl>
              ...
              <dl>
                ...
                <dt>${_`Impermanence`}</dt>
                <dd class="description">${_`See <a href="#anicca">Anicca</a>.`}</dd>
                <dt id="indriya">${_`Indriya`}</dt>
                <dd class="description">
                ...
                <dd>${_`<a href="#saddha">Saddhā</a> (conviction, faith)`}</dd>
                <dd>${_`<a href="#viriya">Viriya</a> (persistence, effort)`}</dd>
                <dd>${_`<a href="#sati">Sati</a> (mindfulness)`}</dd>
                <dd>${_`<a href="#samadhi">Samādhi</a> (concentration)`}</dd>
                <dd>${_`<a href="#panna">Paññā</a> (discernment, wisdom)`}</dd>
                <dd>
                  ${_`A summary of the five faculties: <a class="ref" href="/sn48.10">SN 48.10</a>`}
                </dd>
                <dd>${_`See the suttas in the Indriya-saṁyutta of the Saṁyutta Nikāya`}</dd>
                <dt id="insight">${_`Insight`}</dt>
                <dd class="description">${_`See <a href="#vipassana">Vipassanā</a>.`}</dd>
                <dt id="integrity">${_`Integrity`}</dt>
                <dd class="description">
                ...
                <dt>${_`Intention, intentional action`}</dt>
                <dd class="description">${_`See <a href="#kamma">Kamma</a>.`}</dd>
              </dl>
              <h2 id="j">${_`J`}</h2>
              <dl>
                <dt>${_`Jātaka tales`}</dt>
                <dd class="description">${_`Stories from the Buddha’s previous lives.`}</dd>
                <dd>${_`The chariot-maker: <a class="ref" href="/an3.15">AN 3.15</a>`}</dd>
                <dd>
                  ${_`The story of prince Dīghāvu: <a class="ref" href="/kd10.2.3">Kd 10.2.3–20</a>`}
                </dd>
                <dt id="jati">${_`Jāti`}</dt>
                <dd class="description">
                ...
                <dd>${_`And mindfulness: <a class="ref" href="/sn2.7">SN 2.7</a>`}</dd>
                <dd>
                ...
                <dd>${_`Paves the way to Nibbāna: <a class="ref" href="/dhp372">Dhp 372</a>`}</dd>
                <dd>${_`Envied by the devas: <a class="ref" href="/dhp181">Dhp 181</a>`}</dd>
                <dd>
                ...
                <dt>${_`Joy, appreciative/sympathetic`}</dt>
                <dd class="description">${_`See <a href="#mudita">Muditā</a>.`}</dd>
              </dl>
              <h2 id="k">${_`K`}</h2>
              <dl>
                <dt id="kalyanamittata">${_`Kalyanamittatā`}</dt>
                <dd class="description">
                ...
                <dd>${_`Benefits of ~: <a class="ref" href="/an9.1">AN 9.1</a>`}</dd>
                <dd>
                ...
                <dd>${_`Avoiding lazy people: <a class="ref" href="/iti78">Iti 78</a>`}</dd>
                <dd>
                ...
                <dd>${_`Systematic practice of ~: <a class="ref" href="/sn42.8">SN 42.8</a>`}</dd>
                <dd>
                  ${_`Practicing ~ as a way to deal with annoying people: <a class="ref" href="/an5.161">AN 5.161</a>`}
                </dd>
                <dt id="kayagatasati">${_`Kāyagatāsati`}</dt>
                <dd class="description">
                ...
                <dd>${_`See the suttas in the Khandhavagga of the Saṁyutta Nikāya.`}</dd>
                <dd>
                  ${_`How we define ourselves in terms of the ~: <a class="ref" href="/sn22.36">SN 22.36</a>`}
                </dd>
                <dd>${_`A summary of the ~: <a class="ref" href="/sn22.48">SN 22.48</a>`}</dd>
                <dd>
                ...
                <dd>${_`Voidness of the ~: <a class="ref" href="/sn22.95">SN 22.95</a>`}</dd>
                <dd>
                ...
                <dd>
                  ...
                  <ul>
                    <li>${_`Rūpa (form, physical phenomena)`}</li>
                    <li>${_`<a href="#vedana">Vedanā</a> (feeling)`}</li>
                    <li>${_`<a href="#sanna">Saññā</a> (perception)`}</li>
                    <li>${_`<a href="#sankhara">Saṅkhāra</a> (choice, intentions, conditions)`}</li>
                    <li>${_`<a href="#vinnana">Viññāṇa</a> (consciousness)`}</li>
                  </ul>
                </dd>
                <dt id="khanti">${_`Khanti`}</dt>
                <dd class="description">
                ...
                <dd>${_`Heals the angry person: <a class="ref" href="/sn11.4">SN 11.4</a>`}</dd>
                <dd>${_`How to develop ~: <a class="ref" href="/mn21">MN 21</a>`}</dd>
                <dd>
                ...
                <dd>${_`As putrefaction: <a class="ref" href="/an3.126">AN 3.126</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ burn like fire: <a class="ref" href="/iti93">Iti 93</a>`}</dd>
                <dd>
                  ${_`~ are like dirty stains on an otherwise clean cloth: <a class="ref" href="/mn7">MN 7</a>`}
                </dd>
                <dt id="killing">${_`Killing`}</dt>
                <dd class="description">
              ...
              <h2 id="l">${_`L`}</h2>
              <dl>
                <dt id="lay">${_`Lay Buddhist practice`}</dt>
                <dd class="description">
                ...
                <dt id="laziness">${_`Laziness`}</dt>
                <dd class="description">
                  ${_`See <a href="#sloth">Sloth and Drowsiness</a> (thīna-middha).`}
                </dd>
                <dt id="listen">${_`Listening`}</dt>
                <dd class="description">${_`See also <a href="#speech">Speech</a>.`}</dd>
                <dd>
                ...
                <dt id="samma-ajivo">${_`Livelihood, Right`}</dt>
                <dd>
                ...
                <dt id="lokadhamma">${_`Lokadhamma`}</dt>
                <dd class="description">
                  ${_`<span class="translation">worldly conditions</span>`}
                </dd>
                <dd>${_`The failings of the world: <a class="ref" href="/an8.6">AN 8.6</a>`}</dd>
                <dd>
                ...
                <dt>${_`Loving-kindness`}</dt>
                <dd class="description">${_`See <a href="#metta">Mettā</a>.`}</dd>
                <dt>${_`Lust`}</dt>
                <dd class="description">${_`See <a href="#sensuality">Sensuality</a>.`}</dd>
              </dl>
              <h2 id="m">${_`M`}</h2>
              <dl>
                <dt id="mana">${_`Māna`}</dt>
                <dd class="description">${_`<span class="translation">conceit</span>`}</dd>
                <dd>
                  ${_`As a motivation for practice: <a class="ref" href="/an4.159">AN 4.159</a>`}
                </dd>
                <dd>${_`As a cause of grief: <a class="ref" href="/sn21.2">SN 21.2</a>`}</dd>
                <dd>
                ...
                <dd>${_`Etiquette and duties for monks: <a class="ref" href="/kd18">Kd 18</a>`}</dd>
                <dt id="mara">${_`Māra`}</dt>
                <dd>${_`Ten armies of: <a class="ref" href="/snp3.2">Snp 3.2</a>`}</dd>
                <dt id="maranassati">${_`Maraṇassati`}</dt>
                <dd class="description">
                ...
                <dd>${_`Spouses’ duties to each other: <a class="ref" href="/dn31">DN 31</a>`}</dd>
                <dt id="meditation">${_`Meditation`}</dt>
                <dd class="description">
                ...
                <dt id="merit">${_`Merit`}</dt>
                <dd class="description">${_`See <a href="#punna">Puñña</a>.`}</dd>
                <dt id="metta">${_`Mettā`}</dt>
                <dd class="description">
                ...
                <dd>${_`Systematic practice of ~: <a class="ref" href="/sn42.8">SN 42.8</a>`}</dd>
                <dd>${_`Eleven benefits of ~: <a class="ref" href="/an11.16">AN 11.16</a>`}</dd>
                <dd>
                ...
                <dd>${_`The radiant brightness of ~: <a class="ref" href="/iti27">Iti 27</a>`}</dd>
                <dd>
                ...
                <dt>${_`Middle way`}</dt>
                <dd>${_`<span class="translation">Majjhimā paṭipadā</span>`}</dd>
                <dd>${_`Avoiding extreme views: <a class="ref" href="/sn12.15">SN 12.15</a>`}</dd>
                <dd>
                ...
                <dt id="mindfulness">${_`Mindfulness`}</dt>
                <dd class="description">${_`See <a href="#sati">Sati</a>.`}</dd>
                <dt>${_`Mind-reading.`}</dt>
                <dd>${_`One’s own mind: <a class="ref" href="/an10.51">AN 10.51</a>`}</dd>
                <dd>${_`Another’s mind: See <a href="#supranormal">Supranormal powers</a>`}</dd>
                <dt id="moderation">${_`Moderation`}</dt>
                <dd class="description">${_`See also <a href="#restraint">Restraint</a>.`}</dd>
                <dd>
                ...
                <dt id="monastic">${_`Monastic Life`}</dt>
                <dd class="description">
                ...
                <dd>${_`The fruits of the homeless life: <a class="ref" href="/dn2">DN 2</a>`}</dd>
                <dd>${_`Gradual training for monks: <a class="ref" href="/mn107">MN 107</a>`}</dd>
                <dd>
                ...
                <dd>${_`A monk’s duties: <a class="ref" href="/kd18">Kd 18</a>`}</dd>
                <dd>
              ...
              <dl>
                ...
                <dt id="nekkhamma">${_`Nekkhamma`}</dt>
                <dd class="description">
                ...
                <dd>${_`The bliss of ~: <a class="ref" href="/ud2.10">Ud 2.10</a>`}</dd>
                <dd>
                ...
                <dd>${_`The foremost: <a class="ref" href="/dhp184">Dhp 184</a>`}</dd>
                <dd>${_`The foremost ease: <a class="ref" href="/dhp202">Dhp 202</a>`}</dd>
                <dd>
                ...
                <dd>${_`What lies beyond ~? <a class="ref" href="/an4.174">AN 4.174</a>`}</dd>
                <dd>
                  ${_`~ is the goal; there’s nothing beyond it: <a class="ref" href="/mn144">MN 144</a>`}
                </dd>
                <dd>${_`~ is beyond Māra’s reach: <a class="ref" href="/sn4.19">SN 4.19</a>`}</dd>
                <dd>
                ...
                <dt id="nirvana">${_`Nirvāṇa`}</dt>
                <dd class="description">${_`See <a href="#nibbana">Nibbāna</a>.`}</dd>
                <dt id="nivarana">${_`Nīvaraṇa`}</dt>
                <dd class="description">
                ...
                <dd>
                  ...
                  <ul>
                    <li>${_`<a href="#lobha">Sensual desire</a> (kāmacchanda)`}</li>
                    <li>${_`<a href="#ill">Ill-will</a> (vyāpāda)`}</li>
                    <li>${_`<a href="#sloth">Sloth and Drowsiness</a> (thīna-middha)`}</li>
                    <li>
                      ${_`<a href="#restlessness">Restlessness and worry</a> (uddhacca-kukkucca)`}
                    </li>
                    <li>${_`<a href="#doubt">Doubt</a> (vicikicchā)`}</li>
                  </ul>
                </dd>
                <dd>
                ...
                <dd>${_`How to abandon the ~: <a class="ref" href="/an9.64">AN 9.64</a>`}</dd>
                <dd>
                ...
                <dt id="eightfold">${_`Noble Eightfold Path`}</dt>
                <dd class="description">
                ...
                <dd>
                  ...
                  <dl>
                    ...
                    <dt>${_`Right Action`}</dt>
                    <dd class="description">
                      ${_`<span class="translation">sammā-kammanta</span>`}
                    </dd>
                    <dt>${_`Right Livelihood`}</dt>
                    <dd class="description">${_`<span class="translation">sammā-ājīva</span>`}</dd>
                    <dt>${_`Right Effort`}</dt>
                    <dd class="description">${_`<span class="translation">sammā-vāyāma</span>`}</dd>
                    <dt>${_`Right Mindfulness`}</dt>
                    <dd class="description">${_`<span class="translation">sammā-sati</span>`}</dd>
                    <dt>${_`Right Immersion`}</dt>
                    <dd class="description">
                ...
                <dt id="silence">${_`Noble silence`}</dt>
                <dd class="description">${_`second <a href="#jhana">jhāna</a>`}</dd>
                <dd>${_`~ explained: <a class="ref" href="/sn21.1">SN 21.1</a>`}</dd>
                <dd>${_`No-thinking: <a class="ref" href="/thag14.1">Thag 14.1</a>`}</dd>
                <dd>
                ...
                <dt id="ahimsa">${_`Non-harming, Non-violence`}</dt>
                <dd class="description">
                ...
                <dd>${_`“The Rod” (Dhammapada chapter 10)`}</dd>
                <dt>${_`Not-self`}</dt>
                <dd class="description">${_`See <a href="#anatta">Anattā</a>.`}</dd>
                <dt id="nutriment">${_`Nutriment`}</dt>
                <dd class="description">
                ...
                <dt>${_`Nymphs, dove-footed`}</dt>
                <dd>${_`<a class="ref" href="/ud3.2">Ud 3.2</a>`}</dd>
              </dl>
              <h2 id="o">${_`O`}</h2>
              <dl>
                <dt id="ottappa">${_`Ottappa`}</dt>
                <dd class="description">
              ...
              <dl>
                ...
                <dt id="parami">${_`Pāramīs`}</dt>
                <dd class="description">${_`<span class="translation">perfections</span>.`}</dd>
                <dd>
                  ${_`Not found in the technical sense in the early texts. However, you can look under each of the\n                constituent factors:\n                `}
                  <ul>
                    <li>${_`<a href="#dana">Dāna</a> (generous action)`}</li>
                    <li>${_`<a href="#sila">Sīla</a> (virtue)`}</li>
                    <li>${_`<a href="#nekkhamma">Nekkhamma</a> (renunciation)`}</li>
                    <li>${_`<a href="#panna">Paññā</a> (wisdom, discernment)`}</li>
                    <li>${_`<a href="#viriya">Viriya</a> (energy, effort)`}</li>
                    <li>${_`<a href="#khanti">Khanti</a> (patience)`}</li>
                    <li>${_`<a href="#sacca">Sacca</a> (truthfulness)`}</li>
                    <li>${_`<a href="#adhitthana">Adhiṭṭhāna</a> (determination, resolution)`}</li>
                    <li>${_`<a href="#metta">Mettā</a> (goodwill, loving-kindness)`}</li>
                    <li>${_`<a href="#upekkha">Upekkhā</a> (equanimity)`}</li>
                  </ul>
                </dd>
                <dt id="parents">${_`Parents`}</dt>
                <dd class="description">
                ...
                <dd>${_`Supporting one’s ~: <a class="ref" href="/snp2.4">Snp 2.4</a>`}</dd>
                <dd>
                  ${_`At one time or another, we have all been each other’s ~: <a class="ref" href="/sn15.14">SN 15.14</a>`}
                </dd>
                <dd>
                ...
                <dt id="parinibbana">${_`Parinibbana`}</dt>
                <dd class="description">
                ...
                <dt id="parisa">${_`Parisā`}</dt>
                <dd class="description">${_`The Buddha’s following`}</dd>
                <dd>
                ...
                <dd>${_`A synopsis of ~: <a class="ref" href="/sn12.2">SN 12.2</a>`}</dd>
                <dd>
                ...
                <dd>
                  ...
                  <ul>
                    <li>${_`<a href="#avijja">Avijjā</a> (ignorance)`}</li>
                    <li>${_`<a href="#sankhara">Saṅkhāra</a> (mental fabrications)`}</li>
                    <li>${_`<a href="#vinnana">Viññāṇa</a> (consciousness)`}</li>
                    <li>${_`<a href="#namarupa">Nama-rūpa</a> (name-and-form)`}</li>
                    <li>${_`<a href="#salayatana">Saḷāyatana</a> (six sense-media)`}</li>
                    <li>${_`<a href="#phassa">Phassa</a> (contact)`}</li>
                    <li>${_`<a href="#vedana">Vedanā</a> (feeling)`}</li>
                    <li>${_`<a href="#tanha">Taṇhā</a> (craving)`}</li>
                    <li>${_`<a href="#upadana">Upādāna</a> (clinging)`}</li>
                    <li>${_`<a href="#bhava">Bhava</a> (becoming)`}</li>
                    <li>${_`<a href="#jati">Jāti</a> (birth)`}</li>
                    <li>${_`<a href="#dukkha">Dukkha</a> (suffering, unsatisfactoriness).`}</li>
                  </ul>
                </dd>
                <dt>${_`Patience`}</dt>
                <dd class="description">${_`See <a href="#khanti">Khanti</a>.`}</dd>
                <dt id="patimokkha">${_`Pātimokkha`}</dt>
                <dd class="description">
                  ${_`<span class="translation">monks’ and nuns’ rules of conduct</span>. See <a href="#vinaya">Vinaya</a>.`}
                </dd>
                <dt>${_`Perception`}</dt>
                <dd class="description">${_`See <a href="#sanna">Saññā</a>.`}</dd>
                <dt>${_`Perfections`}</dt>
                <dd class="description">${_`See <a href="#parami">Pāramīs</a>.`}</dd>
                <dt id="peta">${_`Peta loka`}</dt>
                <dd class="description">
                  ${_`<span class="translation">realm of the hungry ghosts/shades</span>. See <a href="#planes">Planes of Existence, Thirty-one</a>.`}
                </dd>
                <dt id="phassa">${_`Phassa`}</dt>
                <dd class="description">
                ...
                <dt id="piti">${_`Pīti`}</dt>
                <dd class="description">
                  ${_`<span class="translation">rapture; bliss</span>. See also <a href="#jhana">Jhāna</a>.`}
                </dd>
                <dd>${_`The pleasure and joy of ~:<a class="ref" href="/an5.176">AN 5.176</a>`}</dd>
                <dt id="planes">${_`Planes of Existence, Thirty-one`}</dt>
                <dd class="description">
                ...
                <dt id="pleasure">${_`Pleasure`}</dt>
                <dd class="description">
                  ${_`See also <a href="#happiness">Happiness</a>; <a href="#pain">Pain</a>; <a href="#sensuality">Sensuality</a>; <a href="#vedana">Vedanā</a> (feeling).`}
                </dd>
                <dd>${_`The many kinds of pleasure: <a class="ref" href="/mn59">MN 59</a>`}</dd>
                <dd>${_`The origin of ~ and pain: <a class="ref" href="/sn12.25">SN 12.25</a>`}</dd>
                <dd>
                ...
                <dt id="present">${_`The present`}</dt>
                <dd>${_`This present is all there is: <a class="ref" href="/mn131">MN 131</a>`}</dd>
                <dt id="protection">${_`Protection`}</dt>
                <dd class="description">
                ...
                <dd>${_`How to gain immeasurable ~: <a class="ref" href="/dhp195">Dhp 195</a>`}</dd>
                <dd>
                  ${_`Do meritorious deeds to increase your store for future lives: <a class="ref" href="/sn3.20">SN 3.20</a>`}
                </dd>
                <dd>${_`Don’t be afraid of ~: <a class="ref" href="/iti22">Iti 22</a>`}</dd>
                <dd>
                ...
                <dd>${_`As a fund to be looked after: <a class="ref" href="/kp8">Kp 8</a>`}</dd>
                <dd>
              ...
              <dl>
                <dt>${_`Quarreling`}</dt>
                <dd class="description">${_`See <a href="#conflict">Conflict</a>.`}</dd>
                <dt id="questions">${_`Questions`}</dt>
                <dd class="description">
                  ${_`See also <a href="#ditthi">Diṭṭhi</a> (views); <a href="#yoniso">Yoniso manasikāra</a> (appropriate attention).`}
                </dd>
                <dd>${_`Four types of ~: <a class="ref" href="/an4.42">AN 4.42</a>`}</dd>
                <dd>
                  ${_`Five motivations behind asking ~: <a class="ref" href="/an5.165">AN 5.165</a>`}
                </dd>
                <dd>${_`How to answer ~: <a class="ref" href="/an3.67">AN 3.67</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ the Buddha left unanswered: Avyākata Saṁyutta`}</dd>
                <dd>
              ...
              <dl>
                <dt>${_`Racism`}</dt>
                <dd class="description">${_`See <a href="#caste">Caste system</a>.`}</dd>
                <dt id="radiant">${_`Radiant Mind`}</dt>
                <dd>
                  ${_`The mind is radiant when freed from defilements: <a class="ref" href="/an1.49">AN 1.49</a>`}
                </dd>
                <dt>${_`Rapture`}</dt>
                <dd class="description">${_`See <a href="#piti">Pīti</a>.`}</dd>
                <dt>${_`Realms of Existence`}</dt>
                <dd class="description">${_`See <a href="#planes">Planes of Existence</a>.`}</dd>
                <dt id="rebirth">${_`Rebirth`}</dt>
                <dd class="description">
                ...
                <dt id="recollections">${_`Recollections, ten`}</dt>
                <dd class="description">${_`<span class="translation">anussati</span>`}</dd>
                <dd>
                ...
                <dt id="reconciliation">${_`Reconciliation`}</dt>
                <dt id="refuge">${_`Refuge`}</dt>
                <dd class="description">
                  ${_`See also <a href="#precepts">Precepts</a>; <a href="#tiratana">Tiratana</a> (the Three Gems).`}
                </dd>
                <dd>${_`The formula for going for ~: <a class="ref" href="/kp1">Kp 1</a>`}</dd>
                <dd>${_`The supreme ~: <a class="ref" href="/dhp188">Dhp 188</a>`}</dd>
                <dd>
                ...
                <dt>${_`Release`}</dt>
                <dd class="description">${_`See <a href="#vimutti">Vimutti</a>.`}</dd>
                <dt id="relics">${_`Relics`}</dt>
                <dd class="description">${_`See also <a href="#devotion">Devotion</a>.`}</dd>
                <dd>${_`Origin of relic-worship: <a class="ref" href="/dn16">DN 16</a>`}</dd>
                <dt id="remorse">${_`Remorse`}</dt>
                <dd class="description">${_`See also <a href="#sila">Sīla</a>.`}</dd>
                <dd>${_`Two causes of ~: <a class="ref" href="/iti30">Iti 30</a>`}</dd>
                <dd>${_`Two causes of no ~: <a class="ref" href="/iti31">Iti 31</a>`}</dd>
                <dd>
                ...
                <dt>${_`Renunciation`}</dt>
                <dd class="description">${_`See <a href="#nekkhamma">Nekkhamma</a>.`}</dd>
                <dt id="respect">${_`Respect`}</dt>
                <dd class="description">
                ...
                <dt id="restlessness">${_`Restless and worry`}</dt>
                <dd class="description">
                  ${_`<span class="translation">uddhacca-kukkucca</span>`}
                </dd>
                <dd>${_`Antidote for ~: <a class="ref" href="/sn46.53">SN 46.53</a>`}</dd>
                <dt id="restraint">${_`Restraint`}</dt>
                <dd class="description">
                ...
                <dd>${_`Definition of ~: <a class="ref" href="/sn35.206">SN 35.206</a>`}</dd>
                <dd>
                ...
                <dd>${_`~ paves the way to Nibbāna: <a class="ref" href="/dhp289">Dhp 289</a>`}</dd>
                <dd>${_`As a refuge: <a class="ref" href="/an3.52">AN 3.52</a>`}</dd>
                <dd>${_`As a support to meditation: <a class="ref" href="/dn2">DN 2</a>`}</dd>
                <dd>
              ...
              <dl>
                ...
                <dd>${_`A rare destination: <a class="ref" href="/dhp174">Dhp 174</a>`}</dd>
                <dd>${_`Causes of rebirth in ~: <a class="ref" href="/iti71">Iti 71</a>`}</dd>
                <dd>
                  ${_`Proper use of wealth leads to rebirth in ~: <a class="ref" href="/sn3.19">SN 3.19</a>`}
                </dd>
                <dt id="sakkaya">${_`Sakkāya-diṭṭhi`}</dt>
                <dd class="description">
                ...
                <dd>${_`How ~ comes about: <a class="ref" href="/mn109">MN 109</a>`}</dd>
                <dd>${_`How to develop ~: <a class="ref" href="/mn148">MN 148</a>`}</dd>
                <dd>${_`How to relinquish ~: <a class="ref" href="/mn148">MN 148</a>`}</dd>
                <dd>
                ...
                <dt id="salayatana">${_`Saḷāyatana`}</dt>
                <dd class="description">
                ...
                <dd>${_`See the suttas in the Saḷāyatana-saṁyutta of the Saṁyutta Nikāya.`}</dd>
                <dt id="samadhi">${_`Samādhi`}</dt>
                <dd class="description">
                ...
                <dd>${_`~ is a progressive practice: <a class="ref" href="/mn66">MN 66</a>`}</dd>
                <dd>${_`Five-factored noble ~: <a class="ref" href="/an5.28">AN 5.28</a>`}</dd>
                <dd>
                ...
                <dd>${_`How ~ leads to discernment: <a class="ref" href="/sn22.5">SN 22.5</a>`}</dd>
                <dd>
                  ${_`Which comes first: ~ or wisdom? <a class="ref" href="/an3.73">AN 3.73</a>`}
                </dd>
                <dd>${_`Four developments of ~: <a class="ref" href="/an4.41">AN 4.41</a>`}</dd>
                <dt id="samatha">${_`Samatha`}</dt>
                <dd class="description">
                ...
                <dt id="sammappadhana">${_`Sammāppadhāna`}</dt>
                <dd class="description">
                ...
                <dt id="sampajanna">${_`Sampajañña`}</dt>
                <dd class="description">
                ...
                <dd>${_`Lasts long for fools: <a class="ref" href="/dhp60">Dhp 60</a>`}</dd>
                <dd>
                ...
                <dd>${_`Is a difficult path: <a class="ref" href="/dhp414">Dhp 414</a>`}</dd>
                <dd>
                  ${_`The preciousness of our human birth: <a class="ref" href="/sn20.2">SN 20.2</a>, <a class="ref" href="/sn56.48">SN 56.48</a>`}
                </dd>
                <dd>${_`See the suttas from the Saṁyutta Nikāya on the topic of Saṁsāra.`}</dd>
                <dt id="samvega">${_`Saṁvega`}</dt>
                <dd class="description">
                ...
                <dd>${_`A call to wake up: <a class="ref" href="/snp2.10">Snp 2.10</a>`}</dd>
                <dd>
                ...
                <dd>${_`Concord in the Saṅgha: <a class="ref" href="/iti19">Iti 19</a>`}</dd>
                <dd>
                ...
                <dt id="sanyojana">${_`Saṁyojana`}</dt>
                <dd class="description">${_`<span class="translation">fetter</span>`}</dd>
                <dd>${_`Listed: <a class="ref" href="/an10.13">AN 10.13</a>`}</dd>
                <dt id="sanna">${_`Saññā`}</dt>
                <dd class="description">
                ...
                <dd>${_`Definition of ~: <a class="ref" href="/sn48.10">SN 48.10</a>`}</dd>
                <dd>
                  ${_`As a quality of a great person: <a class="ref" href="/an8.30">AN 8.30</a>`}
                </dd>
                <dt id="satipatthana">${_`Satipaṭṭhāna`}</dt>
                <dd class="description">
                ...
                <dd>${_`See the suttas in the Satipaṭṭhāna-saṁyutta of the Saṁyutta Nikāya`}</dd>
                <dd>
                  ${_`As a basis for the development of jhāna: <a class="ref" href="/an8.63">AN 8.63</a>`}
                </dd>
                <dd>
                ...
                <dt>${_`Seclusion`}</dt>
                <dd class="description">${_`See <a href="#viveka">Viveka</a>.`}</dd>
                <dt>${_`Self-view`}</dt>
                <dd class="description">${_`See <a href="#sakkaya">Sakkāya-diṭṭhi</a>.`}</dd>
                <dt id="sensuality">${_`Sensuality`}</dt>
                <dd class="description">
                ...
                <dd>${_`As a yoke: <a class="ref" href="/an4.10">AN 4.10</a>`}</dd>
                <dd>${_`As a flood: <a class="ref" href="/sn45.171">SN 45.171</a>`}</dd>
                <dd>${_`The allures and drawbacks of ~: <a class="ref" href="/mn13">MN 13</a>`}</dd>
                <dd>${_`Dangers of: <a class="ref" href="/mn45">MN 45</a>`}</dd>
                <dd>
                  ${_`What’s wrong with sensual pleasures? <a class="ref" href="/sn5.6">SN 5.6</a>`}
                </dd>
                <dd>${_`Like falling into debt: <a class="ref" href="/an6.45">AN 6.45</a>`}</dd>
                <dd>
                ...
                <dd>${_`Like a fish caught in a trap: <a class="ref" href="/ud7.4">Ud 7.4</a>`}</dd>
                <dd>
                ...
                <dt id="separation">${_`Separation from what is dear and appealing`}</dt>
                <dd class="description">${_`See also <a href="#dukkha">Dukkha</a>.`}</dd>
                <dt id="sex">${_`Sexual intercourse`}</dt>
                <dd class="description">${_`See also <a href="#sensuality">Sensuality</a>.`}</dd>
                <dd>${_`~ is to be abandoned: <a class="ref" href="/an4.159">AN 4.159</a>`}</dd>
                <dt id="wrongsex">${_`Sexual misconduct`}</dt>
                <dd class="description">
                  ${_`See also <a href="#precepts">Precepts</a>; <a href="#sila">Sīla</a>.`}
                </dd>
                <dd>
                ...
                <dd>${_`Causes of promiscuity: <a class="ref" href="/an2.9">AN 2.9</a>`}</dd>
                <dt>${_`Shame (moral)`}</dt>
                <dd class="description">${_`See <a href="#hiri">Hiri</a>.`}</dd>
                <dt id="sickness">${_`Sickness`}</dt>
                <dd class="description">${_`See <a href="#illness">Illness</a>.`}</dd>
                <dt id="sila">${_`Sīla`}</dt>
                <dd class="description">
                ...
                <dd>${_`As a treasure: <a class="ref" href="/an7.6">AN 7.6</a>`}</dd>
                <dd>${_`Guard your ~ well: <a class="ref" href="/iti76">Iti 76</a>`}</dd>
                <dd>
                ...
                <dd>${_`Admirable ~: <a class="ref" href="/iti97">Iti 97</a>`}</dd>
                <dd>
                ...
                <dt id="sleepiness">${_`Sleepiness`}</dt>
                <dd class="description">
                  ${_`See <a href="#sloth">Sloth and Drowsiness</a> (thīna-middha).`}
                </dd>
                <dt id="sloth">${_`Sloth and Drowsiness`}</dt>
                <dd class="description">
                ...
                <dd>${_`The definition: <a class="ref" href="/sn45.8">SN 45.8</a>`}</dd>
                <dd>
                  ${_`Speak only words that do no harm: <a class="ref" href="/thag21">Thag 21</a>`}
                </dd>
                <dd>
                ...
                <dd>${_`Five aspects of suitable ~: <a class="ref" href="/mn21">MN 21</a>`}</dd>
                <dd>${_`Five keys to blameless ~: <a class="ref" href="/an5.198">AN 5.198</a>`}</dd>
                <dd>
                ...
                <dd>${_`Lying is to be avoided: <a class="ref" href="/iti25">Iti 25</a>`}</dd>
                <dd>
                ...
                <dt id="stream">${_`Stream-entry`}</dt>
                <dd class="description">
                ...
                <dd>${_`Six rewards of ~: <a class="ref" href="/an6.97">AN 6.97</a>`}</dd>
                <dd>
                ...
                <dt id="suicide">${_`Suicide`}</dt>
                <dd class="description">${_`See also <a href="#death">Death</a>.`}</dd>
                <dd>${_`Sappadasa chooses life: <a class="ref" href="/thag6.6">Thag 6.6</a>`}</dd>
                <dt id="supranormal">${_`Supranormal powers`}</dt>
                <dd>
                ...
                <dd>${_`As a miracle: <a class="ref" href="/an3.60">AN 3.60</a>`}</dd>
                <dd>
                ...
                <dd>${_`Drawbacks of ~: <a class="ref" href="/dn11">DN 11</a>`}</dd>
                <dd>${_`A monk displays his ~: <a class="ref" href="/sn41.4">SN 41.4</a>`}</dd>
                <dd>
              ...
              <dl>
                ...
                <dd>${_`As a fetter: <a class="ref" href="/iti15">Iti 15</a>`}</dd>
                <dd>
                ...
                <dd>${_`The Buddha’s simile on ~: <a class="ref" href="/sn22.84">SN 22.84</a>`}</dd>
                <dd>
                ...
                <dd>${_`How to teach Dhamma: <a class="ref" href="/an4.111">AN 4.111</a>`}</dd>
                <dd>
                ...
                <dd>${_`Three kinds of Dhamma teachers: <a class="ref" href="/dn12">DN 12</a>`}</dd>
                <dd>
                ...
                <dt>${_`Thinking`}</dt>
                <dd class="description">${_`See <a href="#thought">Thought</a>.`}</dd>
                <dt id="thought">${_`Thought`}</dt>
                <dd>${_`Habitual ways of thinking: <a class="ref" href="/mn19">MN 19</a>`}</dd>
                <dd>${_`Three kinds of unskillful ~: <a class="ref" href="/iti87">Iti 87</a>`}</dd>
                <dd>${_`Three kinds of skillful ~: <a class="ref" href="/iti87">Iti 87</a>`}</dd>
                <dt>${_`Distracting thoughts.`}</dt>
                <dd>
                ...
                <dt id="tilakkhana">${_`Tilakkhaṇa`}</dt>
                <dd class="description">
                  ${_`<span class="translation">the three characteristics of existence</span>. See also <a href="#vipassana">Vipassanā</a> (insight).`}
                </dd>
                <dt>${_`See each one individually:`}</dt>
                <dd>${_`<a href="#anicca">Anicca</a> (impermanence)`}</dd>
                <dd>${_`<a href="#dukkha">Dukkha</a> (unsatisfactoriness)`}</dd>
                <dd>${_`<a href="#anatta">Anattā</a> (not-self)`}</dd>
                <dd>
                ...
                <dt id="tisarana">${_`Tisaraṇa`}</dt>
                <dd class="description">
                  ${_`<span class="translation">the Threefold Refuge</span>`}
                </dd>
                <dt>${_`Truthfulness`}</dt>
                <dd class="description">${_`See <a href="#sacca">Sacca</a>.`}</dd>
              </dl>
              <h2 id="u">${_`U`}</h2>
              <dl>
                <dt>${_`Unattractiveness`}</dt>
                <dd class="description">${_`See <a href="#asubha">Asubha</a>.`}</dd>
                <dt>${_`Unbinding`}</dt>
                <dd class="description">${_`See <a href="#nibbana">Nibbāna</a>.`}</dd>
                <dt>${_`Universe, origin and fate of`}</dt>
                <dd class="description">
                  ${_`See <a href="#questions">Questions not worth asking</a>.`}
                </dd>
                <dt id="upadana">${_`Upādāna`}</dt>
                <dd class="description">
                ...
                <dd>${_`Three kinds of ~: <a class="ref" href="/sn36.31">SN 36.31</a>`}</dd>
                <dd>
                  ${_`Practicing ~ as a way to deal with annoying people: <a class="ref" href="/an5.161">AN 5.161</a>`}
                </dd>
                <dt id="uposatha">${_`Uposatha`}</dt>
                <dd class="description">
              ...
              <dl>
                ...
                <dd>${_`Seeing ~ as not-self: <a class="ref" href="/dn15">DN 15</a>`}</dd>
                <dd>
                ...
                <dd>${_`See the suttas in the Vedanā-saṁyutta of the Saṁyutta Nikāya`}</dd>
                <dt>${_`Vedanta`}</dt>
                <dd class="description">
                  ${_`See <a href="#comparative">Comparative religions</a>.`}
                </dd>
                <dt id="veggie">${_`Vegetarianism`}</dt>
                <dt id="views">${_`Views`}</dt>
                <dd class="description">${_`See <a href="#ditthi">Diṭṭhi</a>.`}</dd>
                <dt id="vimutti">${_`Vimutti`}</dt>
                <dd class="description">
                ...
                <dd>${_`Released through awareness: <a class="ref" href="/an6.13">AN 6.13</a>`}</dd>
                <dd>
                ...
                <dd>${_`Released “both ways”: <a class="ref" href="/an9.45">AN 9.45</a>`}</dd>
                <dd>
                  ${_`The Buddha’s question-and-answer session concerning release: <a class="ref" href="/snp5">Snp 5</a>`}
                </dd>
                <dt id="vinaya">${_`Vinaya`}</dt>
                <dd class="description">${_`See also <a href="#monastic">Monastic Life</a>.`}</dd>
                <dd>${_`Basic principles of: <a class="ref" href="/an8.53">AN 8.53</a>`}</dd>
                <dd>${_`A monk’s duties: <a class="ref" href="/kd18">Kd 18</a>`}</dd>
                <dd>
                ...
                <dd>${_`The Bhikkhu Pātimokkha: The Bhikkhus’ Code of Discipline`}</dd>
                <dd>${_`The Bhikkhunī Pātimokkha: The Bhikkhunīs’ Code of Discipline`}</dd>
                <dt id="vinnana">${_`Viññāṇa`}</dt>
                <dd class="description">
                ...
                <dt>${_`Violence`}</dt>
                <dd class="description">${_`See <a href="#ahimsa">Non-violence</a>.`}</dd>
                <dt id="vipassana">${_`Vipassanā`}</dt>
                <dd class="description">
                ...
                <dt id="viraga">${_`Virāga`}</dt>
                <dd class="description">${_`<span class="translation">dispassion</span>`}</dd>
                <dd>
              ...
              <h2 id="w">${_`W`}</h2>
              <dl>
                <dt id="wakefulness">${_`Wakefulness`}</dt>
                <dd class="description">
                ...
                <dt id="walking">${_`Walking meditation`}</dt>
                <dd class="description">${_`See also <a href="#meditation">Meditation</a>.`}</dd>
                <dd>${_`Benefits of ~: <a class="ref" href="/an5.29">AN 5.29</a>`}</dd>
                <dt id="war">${_`War`}</dt>
                <dd class="description">
                ...
                <dt>${_`Wedding`}</dt>
                <dd class="description">${_`See <a href="#marriage">Marriage</a>.`}</dd>
                <dd>${_`Well, parable of the: <a class="ref" href="/ud7.9">Ud 7.9</a>`}</dd>
                <dt id="wilderness">${_`Wilderness`}</dt>
                <dd class="description">
                ...
                <dd>${_`Wandering like a wild deer: <a class="ref" href="/snp1.3">Snp 1.3</a>`}</dd>
                <dd>
                ...
                <dt>${_`Wings to Awakening`}</dt>
                <dd class="description">
                  ${_`See <a href="#bodhipakkhiya-dhamma">Bodhipakkhiya-dhamma</a>.`}
                </dd>
                <dt>${_`Wisdom`}</dt>
                <dd class="description">${_`See <a href="#panna">Paññā</a>.`}</dd>
                <dt id="wiseperson">${_`Wise person`}</dt>
                <dd class="description">
                ...
                <dt>${_`Wise reflection`}</dt>
                <dd class="description">${_`See <a href="#yoniso">Yoniso manasikāra</a>.`}</dd>
                <dt id="women">${_`Women`}</dt>
                <dd>
                ...
                <dd>${_`Verses of the Elder Nuns (Therīgāthā)`}</dd>
                <dd>${_`The Bhikkhunī Pātimokkha: The Bhikkhunīs’ Code of Discipline`}</dd>
                <dt id="monkwork">${_`Work, monastics’`}</dt>
                <dd class="description">${_`See also <a href="#monastic">Monastic life</a>.`}</dd>
                <dd>
                ...
                <dt>${_`World, origin of`}</dt>
                <dd class="description">
                  ${_`See <a href="#questions">Questions not worth asking</a>.`}
                </dd>
                <dt>${_`Worship`}</dt>
                <dd class="description">${_`See <a href="#devotion">Devotion</a>.`}</dd>
              </dl>
              <h2 id="xyz">${_`XYZ`}</h2>
              <dl>
                <dt id="yoniso">${_`Yoniso manasikāra`}</dt>
                <dd class="description">

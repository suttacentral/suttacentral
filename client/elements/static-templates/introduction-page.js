  ...
  render() {
    return html`
      ...
      <div id="page-wrap">
        <main>
          <section>
            <h1>${_`Introduction to SuttaCentral`}</h1>
            <h2>${_`The Buddha’s words`}</h2>
            <p>
            ...
            <picture>
              <source
                srcset="
                  /img/static-pages/Life_of_Buddha_Burmese_Manuscript_22_Volume_1_Wellcom.avif
                "
                type="image/avif"
              />
              <img
                alt="${_`Cover and binding to a Burmese manuscript on the Life of Buddha in red tooled leather with text in    gold letters. Burma, late 19th century.`}"
                class="image-home-full"
                src="/img/static-pages/Life_of_Buddha_Burmese_Manuscript_22_Volume_1_Wellcom.jpg"
                title="${_`Life of Buddha Burmese Manuscript 22, Volume 1`}"
                width="640px"
              />
            </picture>
            <h2>${_`Themes`}</h2>
            ...
            <p>
              <picture>
                ...
                <img
                  alt="${_`Fragment of Gandhari manuscript on birch bark, acquired by University of Washington. Afghanistan,  circa 1st or 2nd century CE.`}"
                  class="image-home"
                  src="/img/static-pages/birchbark_w400.jpg"
                  title="${_`Abhidharma commentary on suffering`}"
                />
              </picture>
              ${_` Buddhist texts are traditionally classified as the “Three Baskets”, spelled `}
              <i lang="pi">${_`tipiṭaka`}</i>
              ${_` in Pali or `}
              <i lang="san">${_`tripiṭaka`}</i>
            ...
            <ul>
              <li>
                <strong>${_`Original texts:`}</strong>
              ...
              <li>
                ${_`<strong>Parallels:</strong> The foundation of SuttaCentral is our sets of parallels. These detail tens of thousands of cases where texts in different collections or languages correspond with each other. The existence of these parallels shows the connections between the scriptures underlying all Buddhist traditions, a connection that harks back to the Buddha himself.`}
              </li>
            </ul>
            <h2>${_`Relations`}</h2>
            <p>
              <picture>
                ...
                <img
                  alt="${_`Visual representation of relationships for DN 20`}"
                  class="image-home"
                  src="/img/static-pages/dn20.jpg"
                  title="${_`Relationships for DN 20`}"
                  width="640px"
                />
              </picture>
            ...
            <h2>${_`Finding Your Way Around`}</h2>
            <p>
            ...
            <h3>${_`How the Tipiṭaka is organized`}</h3>
            <p>
            ...
            <p>${_`All the Vinayas have a similar structure.`}</p>
            <ul>
              <li>

        ...
        <main>
          <section>
            <article>
              ...
              <p>${_`The caveats expressed by the author of the original index still apply:`}</p>
              <blockquote>
              ...
              <dl>
                ...
                <dd>${_`straightened by a fletcher (see <a href="#fletcher">Fletcher</a> )`}</dd>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`<a id="bathman">Bathman</a> or bathman’s apprentice`}</dt>
                <dd>
                ...
                <dd>${_`sighting shore <span class="subject">seeking the Buddha</span>`}</dd>
                <dd>
                ...
                <dd>${_`See also <a href="#cow">Cow</a>.`}</dd>
                <dt>${_`Burning ghee or oil`}</dt>
                <dd>
                ...
                <dt>${_`Burning grass or leaves`}</dt>
                <dd>
                  ${_`<span class="subject">not-self</span> <a class="ref" href="/sn35.101">SN 35.101</a>`}
                </dd>
                <dt>${_`Burning refuge`}</dt>
                <dd>
                  ${_`<span class="subject">dukkha</span> <a class="ref" href="/snp3.8">Snp 3.8</a>`}
                </dd>
                <dt>${_`<a id="butcher">Butcher</a> or butcher’s apprentice`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#bull">Bull</a>, <a href="#cow">Cow</a>.`}</dd>
                <dt>${_`Butcher of goats`}</dt>
                <dd>
                  ${_`<span class="subject">kamma</span> <a class="ref" href="/an3.99">AN 3.99</a>`}
                </dd>
                <dt>${_`Butter from water`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`Cave`}</dt>
                <dd>${_`<span class="subject">the body</span>`}</dd>
                <dd>
                  ${_`<span class="subject">sensuality</span> <a class="ref" href="/snp4.2">Snp 4.2</a>`}
                </dd>
                <dd></dd>
                <dt>${_`Cesspool difficult to clean`}</dt>
                <dd>
                ...
                <dt>${_`Couple eating their child`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#bull">Bull</a>, <a href="#butcher">Butcher</a>.`}</dd>
                <dt id="cowherd">${_`Cowherd`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#bull">Bull</a>, <a href="#cow">Cow</a>.`}</dd>
                <dt id="crafts">${_`Crafts, Trades, and Professions`}</dt>
                <dd>
              ...
              <h2>${_`<a id="d">D</a>`}</h2>
              <dl>
                <dt>${_`Darkness, intergalactic`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt id="e-tamer">${_`Elephant-tamer`}</dt>
                <dd>
                  ${_`<span class="subject">renunciation</span> <a class="ref" href="/mn125">MN 125</a>`}
                </dd>
                <dt>${_`Embers in a pit`}</dt>
                <dd>
                  ${_`<span class="subject">passion</span> <a class="ref" href="/thig14">Thig 14</a>`}
                </dd>
                <dt>${_`Empty water pot`}</dt>
                <dd>
                  ${_`<span class="subject">mindfulness</span> <a class="ref" href="/mn119">MN 119</a>`}
                </dd>
                <dt>${_`Executioner`}</dt>
                ...
                <dd></dd>
                <dt>${_`Eyes, man opening and closing his`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`Firebrand with excrement`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`<a id="fletcher">Fletcher</a> straightening an arrow`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#river">River</a>, <a href="#ocean">Ocean</a>.`}</dd>
                <dt id="flower">${_`Flower`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#lotus">Lotus</a>.`}</dd>
                <dt>${_`Flower-arranger`}</dt>
                <dd>
                ...
                <dd>${_`root <a class="ref" href="/an10.15">AN 10.15</a>`}</dd>
                <dd>${_`wood <a class="ref" href="/an10.15">AN 10.15</a>`}</dd>
                <dd></dd>
                <dt>${_`Frontier fortress`}</dt>
                <dd>
              ...
              <h2>${_`<a id="g">G</a>`}</h2>
              <dl>
                <dt>${_`Gem with colored thread inside`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt id="goldsmith">${_`Goldsmith`}</dt>
                <dd>
                ...
                <dt>${_`Guest refusing the host’s food`}</dt>
                <dd>
              ...
              <h2>${_`<a id="i">I</a>`}</h2>
              <dl>
                <dt>${_`Illness, man recovering from`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt id="irrigator">${_`Irrigator`}</dt>
                <dd>
                  ${_`<span class="subject">self-control</span> <a class="ref" href="/dhp80">Dhp 80</a>, <a class="ref" href="/dhp145">Dhp 145</a>`}
                </dd>
                <dt>${_`Island`}</dt>
                ...
                <dt>${_`<a id="ivory">Ivory carver</a> or his assistant`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`Man & woman in love <span class="subject">desire</span>"`}</dt>
                <dd>${_`<a class="ref" href="/mn101">MN 101</a>`}</dd>
                <dt>${_`Meat thrown into a fire`}</dt>
                <dd>
                  ${_`<span class="subject">brevity of life</span> <a class="ref" href="/an7.70">AN 7.70</a>`}
                </dd>
                <dt>${_`Merchant with caravan`}</dt>
                <dd>
                  ${_`<span class="subject">avoiding evil</span> <a class="ref" href="/dhp123">Dhp 123</a>`}
                </dd>
                <dt>${_`Middle of the sea`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Morning star`}</dt>
                <dd>
                  ${_`<span class="subject">love</span> <a class="ref" href="/iti27">Iti 27</a>`}
                </dd>
                <dt>${_`Mother risking life for child`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Mountains crushing in from all directions`}</dt>
                <dd>
                ...
                <dt>${_`Mural painted on wall`}</dt>
                <dd>
                  ${_`<span class="subject">the body</span> <a class="ref" href="/thig14">Thig 14</a>`}
                </dd>
                <dt>${_`Murderer with sword`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt id="mustardseed">${_`Mustard seed`}</dt>
                <dd>
              ...
              <h2>${_`<a id="n">N</a>`}</h2>
              <dl>
                <dt>${_`Noise from a soft catskin bag`}</dt>
                <dd>
                  ${_`<span class="subject">speech</span> <a class="ref" href="/mn21">MN 21</a>`}
                </dd>
              </dl>
              ...
              <dl>
                ...
                <dd>${_`See also <a href="#flood">Flood</a>.`}</dd>
                <dt>${_`Oil from gravel`}</dt>
                <dd>
                  ${_`<span class="subject">wrong view</span> <a class="ref" href="/mn126">MN 126</a>`}
                </dd>
                <dt>${_`Oil lamp`}</dt>
              ...
              <h2>${_`<a id="p">P</a>`}</h2>
              <dl>
                <dt>${_`Painting of a woman or man`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Palm leaf dropping away`}</dt>
                <dd>
                ...
                <dd>${_`haunted, <a class="ref" href="/sn3.19">SN 3.19</a>`}</dd>
                <dd></dd>
                <dt id="pool">${_`Pool of water`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`<a id="potter">Potter</a> or potter’s apprentice`}</dt>
                <dd>
                ...
                <dt>${_`Potter’s clay vessels`}</dt>
                <dd>
                  ${_`<span class="subject">inevitability of death</span> <a class="ref" href="/snp3.8">Snp 3.8</a>`}
                </dd>
                <dt>${_`Princes of wattle-and-daub towns`}</dt>
                <dd>
                  ${_`<span class="subject">heedfulness</span> <a class="ref" href="/an10.15">AN 10.15</a>`}
                </dd>
                <dt>${_`Prison, man released from`}</dt>
                <dd>
                  ${_`<span class="subject">hindrances</span> <a class="ref" href="/dn2">DN 2</a>, <a class="ref" href="/dn11">DN 11</a>, <a class="ref" href="/dn12">DN 12</a>, <a class="ref" href="/mn39">MN 39</a>`}
                </dd>
                <dt>${_`Propagation of plants`}</dt>
                <dd>
              ...
              <h2>${_`<a id="qq">Q</a>`}</h2>
              <dl>
                <dt>${_`Quail snared by a rotten creeper`}</dt>
                <dd>
              ...
              <h2>${_`<a id="r">R</a>`}</h2>
              <dl>
                <dt>${_`Rabbit caught in snare`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Rams butting heads`}</dt>
                <dd>
                  ${_`<span class="subject">contact</span> <a class="ref" href="/mil2.3.8">Mil 2.3.8</a>`}
                </dd>
                <dt>${_`Reeds or rushes`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Reflection of one’s face in mirror`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Reservoir with four inlets and outlets`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`Sand castles`}</dt>
                <dd>
                  ${_`<span class="subject">aggregates</span> <a class="ref" href="/sn23.2">SN 23.2</a>`}
                </dd>
                <dt>${_`Saw used by an attacking bandit`}</dt>
                <dd>
                ...
                <dd>${_`rotting in a field: <a class="ref" href="/sn5.10">SN 5.10</a>`}</dd>
                <dd>${_`sweet: <a class="ref" href="/an10.104">AN 10.104</a>`}</dd>
                <dd>${_`See also <a href="#mustardseed">Mustard seed</a>.`}</dd>
                <dt>${_`Seedling not watered`}</dt>
                <dd>
                ...
                <dd>${_`See also <a href="#stream">Stream</a>.`}</dd>
                <dt>${_`Shot with arrow`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Snapping one’s fingers`}</dt>
                <dd>
                ...
                <dt>${_`Spider snared in its own web`}</dt>
                <dd>
                ...
                <dt>${_`Spring-fed lake`}</dt>
                <dd>${_`See <a href="#lake">Lake</a>.`}</dd>
                <dt>${_`Staircase build at a crossroads`}</dt>
                <dd>
                  ${_`<span class="subject">wrong view</span> <a class="ref" href="/dn9">DN 9</a>`}
                </dd>
                <dt>${_`Stallion`}</dt>
                <dd>${_`See <a href="#horse">Horse</a>.`}</dd>
                <dt>${_`Stick thrown up into the air`}</dt>
                <dd>
                  ${_`<span class="subject">rebirth</span> <a class="ref" href="/sn15.9">SN 15.9</a>`}
                </dd>
                <dt>${_`Stone ball thrown into wet clay`}</dt>
                <dd>
                  ${_`<span class="subject">mindfulness</span> <a class="ref" href="/mn119">MN 119</a>`}
                </dd>
                <dt>${_`Storekeeper`}</dt>
                ...
                <dd>${_`See also <a href="#shore">Shore</a>.`}</dd>
                <dt>${_`String, ball of`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Suckling calf going to its mother`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Surgeon`}</dt>
                <dd>${_`see <a href="#doctor">Doctor</a>`}</dd>
                <dt>${_`Swans`}</dt>
                <dd>
              ...
              <h2>${_`<a id="t">T</a>`}</h2>
              <dl>
                <dt>${_`Tall building in central square`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Tortoise evading a jackal`}</dt>
                <dd>
                ...
                <dt>${_`Trades`}</dt>
                <dd>${_`See <a href="#crafts">Crafts and Trades</a>.`}</dd>
                <dt>${_`<a id="trader">Trader</a> watching over a fine steed`}</dt>
                <dd>
                  ${_`<span class="subject">self-training</span> <a class="ref" href="/dhp380">Dhp 380</a>`}
                </dd>
                <dt>${_`Trail in space`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Tuning a stringed instrument`}</dt>
                <dd>
                  ${_`<span class="subject">right effort</span> <a class="ref" href="/an6.55">AN 6.55</a>`}
                </dd>
                <dt>${_`<a id="turban">Turban</a> or head on fire, person with`}</dt>
                <dd>
                ...
                <dt>${_`Turban tightening around one’s head`}</dt>
                <dd>
                  ${_`<span class="subject">pain</span> <a class="ref" href="/mn36">MN 36</a>`}
                </dd>
                <dt>${_`<a id="turner">Turner</a> or turner’s apprentice`}</dt>
                <dd>
                ...
                <dd></dd>
                <dt>${_`Tusker`}</dt>
                <dd>${_`see <a href="#elephant">Elephant</a>.`}</dd>
              </dl>
              <h2>${_`<a id="u">U</a>`}</h2>
              <dl>
                <dt id="upright">${_`Uprighting what had been overturned`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt>${_`Vomit, person eating his or her own`}</dt>
                <dd>
                  ${_`<span class="subject">fetters</span> <a class="ref" href="/mn105">MN 105</a>`}
                </dd>
                <dt>${_`Vulture forced to drop his prey`}</dt>
                <dd>
                  ${_`<span class="subject">sensuality</span> <a class="ref" href="/mn54">MN 54</a>`}
                </dd>
              </dl>
              ...
              <dl>
                ...
                <dd></dd>
                <dt>${_`<a id="weigher">Weigher</a> holding a scale`}</dt>
                <dd>
                  ${_`<span class="subject">virtuous conduct</span> <a class="ref" href="/an8.54">AN 8.54</a>`}
                </dd>
                <dt>${_`Well in desert`}</dt>
                <dd>
                  ${_`<span class="subject">nibbana</span> <a class="ref" href="/sn12.68">SN 12.68</a>`}
                </dd>
                <dt>${_`Wet piece of wood`}</dt>
                <dd>
                  ${_`<span class="subject">mindfulness</span> <a class="ref" href="/mn119">MN 119</a>`}
                </dd>
                <dt>${_`Wheels`}</dt>
                ...
                <dt>${_`Woman meeting her father-in-law`}</dt>
                <dd>

        ...
        <main>
          <section>
            <article>
              ...
              <h3>${_`1. Original material created by SuttaCentral`}</h3>
              <p>
              ...
              <ul>
                <li>${_`Provide a notice of attribution.`}</li>
                <li>${_`Maintain the spirit of the Buddhist tradition.`}</li>
              </ul>
              <p>
                ${_`Please let us know if you would like any assistance in making use of our materials.`}
              </p>
              <h3>${_`2. Material created by others and made available for SuttaCentral`}</h3>
              <p>
              ...
              <ul>
                <li>
                  ...
                  <a
                    ...
                    tager="_blank"
                    title="${_`Creative Commons license`}"
                  >
                  ...
                  <ul>
                    ...
                    <li>${_`“Disconnected cloud icon” by Bernar Novalyi.`}</li>
                  </ul>
                </li>
                <li>
              ...
              <h3>${_`3. Public domain material`}</h3>
              <p>

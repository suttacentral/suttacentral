        ...
        <main>
          <section>
            <article>
              ...
              <p>${_`Here are the general principles we follow.`}</p>
              <ul>
                <li>${_`Prefer the more widely accepted numbering system.`}</li>
                <li>
                ...
                <li>${_`Make multiple referencing systems available where this is useful.`}</li>
                <li>
                  ${_`The primary numbering system is used for the URLs, which are simple, stable, and meaningful.`}
                </li>
              </ul>
              <h2>${_`Segmented Texts`}</h2>
              <p>
              ...
              <h3>${_`Two levels, not three, for AN 1 and AN 2`}</h3>
              <p>
              ...
              <ul>
                <li>${_`AN 1.1.6 becomes AN 1.6`}</li>
                <li>${_`AN 1.8.1 becomes AN 1.71`}</li>
                <li>${_`AN 2.2.9 becomes AN 2.19`}</li>
              </ul>
              <p>${_`Nevertheless, we still retain the three-level PTS numbers for reference.`}</p>
              <h3>${_`Two editions for SN volume 1`}</h3>
              <p>
              ...
              <h3>${_`Use the Bodhi numbering for SN and AN`}</h3>
              <p>
              ...
              <ul>
                <li>${_`SN: from SN 22.150 [SN 22.149] to end of <i>saṁyutta</i>`}</li>
                <li>${_`from SN 35.136 [SN 35.135] to end of <i>saṁyutta</i>`}</li>
                <li>${_`from SN 36.26 [SN 36.25] to end of <i>saṁyutta</i>`}</li>
                <li>${_`AN: from AN 1.98 [AN 1.10.1] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 2.23 [AN 2.3.3 + 2.3.4] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 3.34 [AN 3.33] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 4.227 [AN 4.226] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 7.19 [AN 7.17] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 10.211 [AN 10.200] to end of <i>nipāta</i>`}</li>
                <li>${_`from AN 11.8 [AN 11.9] to end of <i>nipāta</i>`}</li>
              </ul>
              <p>
              ...
              <h3>${_`Multiple sets of verse numbers`}</h3>
              <p>

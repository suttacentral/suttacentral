    ...
    return html`
      ...
      <div id="page-wrap">
        <main>
          <section>
            <article>
              <h1>${_`Basic Pali Terminology`}</h1>
              <p>
              ...
              <h2 id="a">${_`A`}</h2>
              <dl>
                <dt id="abhidhamma">${_`Abhidhamma`}</dt>
                <dd>
                  <ol>
                    <li>
                ...
                <dd>${_`Determination; resolution; sometimes a term for defilements.`}</dd>
                <dt id="akaliko">${_`akāliko`}</dt>
                <dd>${_`Timeless; without interval; in this very life.`}</dd>
                <dt id="akusala">${_`akusala`}</dt>
                <dd>
                  ${_`Unwholesome, unskillful, demeritorious. See its opposite, <a href="#kusala"><i>kusala</i></a>.`}
                </dd>
                <dt id="anagami">${_`anāgāmī`}</dt>
                <dd>
                ...
                <dt id="anapanasati">${_`ānāpānasati`}</dt>
                <dd>
                ...
                <dd>${_`Not-self; ownerless.`}</dd>
                <dt id="anicca">${_`anicca`}</dt>
                <dd>${_`Inconstant; unsteady; impermanent.`}</dd>
                <dt id="anupadisesa-nibbana">${_`anupādisesa-nibbāna`}</dt>
                <dd>
                ...
                <dt id="anupubbi">${_`anupubbī-kathā`}</dt>
                <dd>
                ...
                <dt id="apaya-bhumi">${_`apāya-bhūmi`}</dt>
                <dd>
                ...
                <dt id="ariya-puggala">${_`ariya-puggala`}</dt>
                <dd>
                ...
                <dt id="ariya-sacca">${_`ariya-sacca`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="bhikkhuni">${_`bhikkhunī`}</dt>
                <dd>
                ...
                <dt id="bodhi-pakkhiya-dhamma">${_`bodhi-pakkhiya-dhammā`}</dt>
                <dd>
                  ...
                  <ol>
                    ...
                    <li>${_`five strengths (<i>bala</i>)—identical with [4];`}</li>
                    <li>
                ...
                <dt id="bodhisatta">${_`bodhisatta`}</dt>
                <dd>
                ...
                <dt id="brahma-vihara">${_`brahma-vihāra`}</dt>
                <dd>
                ...
                <dt id="brahman">${_`brahman (from Pali <i>brāhmaṇa</i>)`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt>${_`ceto-vimutti`}</dt>
                <dd>${_`See <a href="#vimutti"><i>vimutti</i></a>.`}</dd>
                <dt id="citta">${_`citta`}</dt>
                <dd>${_`Mind; heart; state of consciousness.`}</dd>
              </dl>
              <h2 id="d">${_`D`}</h2>
              <dl>
                ...
                <dt id="deva">${_`deva; devatā; devaputta`}</dt>
                <dd>
                ...
                <dt id="devadatta">${_`Devadatta`}</dt>
                <dd>
                ...
                <dt id="dhamma-vinaya">${_`Dhamma-vinaya`}</dt>
                <dd>
                ...
                <dd>
                  ...
                  <ol>
                    <li>${_`using only patched-up robes;`}</li>
                    <li>${_`using only one set of three robes;`}</li>
                    <li>${_`going for alms;`}</li>
                    <li>${_`not by-passing any donors on one’s alms path;`}</li>
                    <li>${_`eating no more than one meal a day;`}</li>
                    <li>${_`eating only from the alms-bowl;`}</li>
                    <li>${_`refusing any food offered after the alms-round;`}</li>
                    <li>${_`living in the forest;`}</li>
                    <li>${_`living under a tree;`}</li>
                    <li>${_`living under the open sky;`}</li>
                    <li>${_`living in a cemetery;`}</li>
                    <li>${_`being content with whatever dwelling one has;`}</li>
                    <li>${_`not lying down.`}</li>
                  </ol>
                </dd>
                <dt id="dosa">${_`dosa`}</dt>
                <dd>
                  ${_`Aversion; hatred; anger. One of three unwholesome roots (<i><a href="#mula">mūla</a></i>) in the mind.`}
                </dd>
                <dt id="dukkha">${_`dukkha`}</dt>
                <dd>${_`Suffering; pain; distress; discontent.`}</dd>
              </dl>
              <h2 id="e">${_`E`}</h2>
              <dl>
                <dt id="ekaggatarammana">${_`ekaggatārammana`}</dt>
                <dd>
                ...
                <dt id="ekayana">${_`ekāyana-magga`}</dt>
                <dd>
              ...
              <h2 id="f">${_`F`}</h2>
              <dl>
                <dt>${_`foundation of mindfulness`}</dt>
                <dd>${_`see <a href="#satipatthana"><i>Satipaṭṭhāna</i></a>.`}</dd>
                <dt id="frame">${_`frame of reference`}</dt>
                <dd>${_`see <a href="#satipatthana"><i>Satipaṭṭhāna</i></a>.`}</dd>
              </dl>
              <h2 id="g">${_`G`}</h2>
              <dl>
                <dt id="gotarabhu">${_`gotrabhū`}</dt>
                <dd>
              ...
              <h2 id="h">${_`H`}</h2>
              <dl>
                <dt id="hiri-ottappa">${_`hiri-ottappa`}</dt>
                <dd>
              ...
              <h2 id="i">${_`I`}</h2>
              <dl>
                <dt id="idappaccayata">${_`idappaccayatā`}</dt>
                <dd>
              ...
              <h2 id="k">${_`K`}</h2>
              <dl>
                <dt id="kalyanamitta">${_`kalyāṇamitta`}</dt>
                <dd>${_`Admirable friend; a mentor or teacher of Dhamma.`}</dd>
                <dt id="kamaguna">${_`kāmaguṇa`}</dt>
                <dd>
                ...
                <dt id="kayagata-sati">${_`kāyagatā-sati`}</dt>
                <dd>
              ...
              <h2 id="l">${_`L`}</h2>
              <dl>
                <dt id="lakkhana">${_`lakkhaṇa`}</dt>
                <dd>${_`See <a href="#ti-lakkhana"><i>ti-lakkhaṇa</i></a>.`}</dd>
                <dt id="lobha">${_`lobha`}</dt>
                <dd>
                ...
                <dt id="loka-dhamma">${_`loka-dhamma`}</dt>
                <dd>
                ...
                <dt id="lokavidu">${_`lokavidū`}</dt>
                <dd>${_`Knower of the cosmos. An epithet for the Buddha.`}</dd>
                <dt id="lokuttara">${_`lokuttara`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="majjhima">${_`majjhimā`}</dt>
                <dd>${_`Middle; appropriate; just right.`}</dd>
              ...
              <dl>
                ...
                <dt id="nama-rupa">${_`nāma-rūpa`}</dt>
                <dd>
                ...
                <dd>${_`Renunciation; literally, “freedom from sensual lust”.`}</dd>
                ...
                <dt id="nirodha">${_`nirodha`}</dt>
                <dd>${_`Cessation; disbanding; stopping.`}</dd>
              ...
              <h2 id="o">${_`O`}</h2>
              <dl>
                <dt id="opanayiko">${_`opanayiko`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="paccattam">${_`paccattaṁ`}</dt>
                <dd>${_`Personal; individual.`}</dd>
                <dt id="pacceka">${_`paccekabuddha`}</dt>
                <dd>
                ...
                <dd>${_`Discernment; insight; wisdom; intelligence; common sense; ingenuity.`}</dd>
                <dt>${_`paññā-vimutti`}</dt>
                <dd>${_`See <a href="#vimutti"><i>vimutti</i></a>.`}</dd>
                <dt id="papanca">${_`papañca`}</dt>
                <dd>
                  ${_`The tendency of the mind to proliferate issues from the sense of “self”.`}
                </dd>
                <dt id="parami">${_`pāramī, pāramitā`}</dt>
                <dd>
                ...
                <dt id="parinibbana">${_`parinibbāna`}</dt>
                <dd>
                ...
                <dt id="pariyatti">${_`pariyatti`}</dt>
                <dd>
                ...
                <dt id="patipatti">${_`paṭipatti`}</dt>
                <dd>
                ...
                <dt id="pativedha">${_`paṭivedha`}</dt>
                <dd>
              ...
              <h2 id="r">${_`R`}</h2>
              <dl>
                <dt id="raga">${_`rāga`}</dt>
                <dd>${_`Lust; greed. See <i><a href="#lobha">lobha</a></i>.`}</dd>
                <dt id="rupa">${_`rūpa`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="sakadagami">${_`sakadāgāmī`}</dt>
                <dd>
                ...
                <dt id="sakkaya-ditthi">${_`sakkāya-diṭṭhi`}</dt>
                <dd>
                ...
                <dt id="sakyamuni">${_`Sākyamuni`}</dt>
                <dd>${_`“Sage of the Sakyans”; an epithet for the Buddha.`}</dd>
                <dt id="sakya-putta">${_`sākya-putta`}</dt>
                <dd>
                ...
                <dt id="sallekha-dhamma">${_`sallekha-dhamma`}</dt>
                <dd>
                ...
                <dt id="sambhavesin">${_`sambhavesin`}</dt>
                <dd>${_`A being in the process of becoming reborn.`}</dd>
                <dt id="sammuti">${_`sammuti`}</dt>
                <dd>
                ...
                <dt id="samyojana">${_`saṁyojana`}</dt>
                <dd>
                ...
                <dt id="sanditthiko">${_`sandiṭṭhiko`}</dt>
                <dd>
                ...
                <dt id="sanyojana">${_`sanyojana`}</dt>
                <dd>${_`See <a href="#samyojana"><i>saṁyojana</i></a>.`}</dd>
                <dt id="sasana">${_`sāsana`}</dt>
                <dd>
                ...
                <dt id="sa-upadisesa-nibbana">${_`sa-upādisesa-nibbāna`}</dt>
                <dd>
                ...
                <dt id="sotapanna">${_`sotāpanna`}</dt>
                <dd>
                ...
                <dt>${_`stream-entry, stream-winner`}</dt>
                <dd>${_`see <a href="#sotapanna"><i>sotāpanna</i></a>.`}</dd>
                <dt>${_`stress`}</dt>
                <dd>${_`See <a href="#dukkha"><i>dukkha</i></a>.`}</dd>
                <dt id="stupa">${_`stupa (Pali: <i>thūpa</i>)`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="tathagata">${_`Tathāgata`}</dt>
                <dd>
                ...
                <dt id="ti-lakkhana">${_`ti-lakkhaṇa`}</dt>
                <dd>
              ...
              <h2 id="u">${_`U`}</h2>
              <dl>
                <dt id="ugghatitannu">${_`ugghaṭitaññu`}</dt>
                <dd>
                ...
                <dt id="upasampada">${_`upasampadā`}</dt>
                <dd>
                ...
                <dt id="upasika">${_`upāsaka/upāsikā`}</dt>
                <dd>
              ...
              <dl>
                ...
                <dt id="vesak">${_`Vesak, Vesakha, Visakha, Wesak, etc. (visākha)`}</dt>
                <dd>
                ...
                <dt id="vijja-carana">${_`vijjā-caraṇa-sampanno`}</dt>
                <dd>

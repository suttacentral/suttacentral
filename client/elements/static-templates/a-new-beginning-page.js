          ...
          <section>
            <article>
              ...
              <ul>
                ...
                <li>${_`Descriptive summaries explain the texts and categories.`}</li>
                <li>${_`Parallels show the relationships between texts more clearly.`}</li>
                <li>${_`Thousands more parallels and connections.`}</li>
                <li>${_`We now support multiple translations in the same language.`}</li>
                <li>

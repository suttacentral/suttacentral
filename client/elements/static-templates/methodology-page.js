    ...
    <div id="page-wrap">
      <main>
        <section>
          <article>
            <h1>
              ${_`Methodology and Sources`}
            </h1>
            <nav class="contents">
              <ol>
                <li>
                  ${_`<a href="#item1">Background</a>`}
                </li>
                <li>
                  ${_`<a href="#item2">Sutta parallels</a>`}
                </li>
                <li>
                  ${_`<a href="#item3">Vinaya parallels</a>`}
                </li>
                <li>
                  ${_`<a href="#item4">Text sources</a>`}
                </li>
                <li>
                  ${_`<a href="#item5">Markup</a>`}
                </li>
                <li>
                  ${_`<a href="#item6">Bibliographies</a>`}
                </li>
              </ol>
            </nav>
            <h2 id="item1">
            ...
            <p class="byline">
              ${_`Rod Bucknell, updated by Sujato`}
            </p>
            <h3>
              ${_`Kinds of Parallels`}
            </h3>
            <p>
            ...
            <p>
              ${_`Note that, due to the nature of the Vinaya texts, there is no need for the different kinds of relations as specified for the Suttas. In almost all cases, it is clear that a particular rule is a full parallel of the other rules, in the sense that they different versions of the same “thing”. There are, of course, occasional exceptions to this, but nothing, I think, is to be gained by trying to specify a few such marginal cases in the data.`}
            </p>
            <h2 id="item4">
              ${_`Text sources`}
            </h2>
            ...
            <p>
              ${_`Translations are from many different sources as noted in each text.`}
            </p>
            <h2 id="item5">
              ${_`Markup`}
            </h2>
            ...
            <p>
              ${_`Here I will give the basic outlines of some of the less obvious details.`}
            </p>
            <h3>
              ${_`References`}
            </h3>
            ...
            <ul>
              ...
              <li>
                ${_`Various kinds of numbers, such as rule numbers.`}
              </li>
              <li>
                ${_`Verses.`}
              </li>

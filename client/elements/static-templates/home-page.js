    ...
    return html`
      ...
      <div class="bottom-space" id="page-wrap">
        <div class="content">
                ...
                <div class="card-content">
                  <div class="card-content-text">
                    <div class="card-text center-text buddhas-words-text">
                      <sc-text-carousel
                        class="carousel"
                        .elementsUrl="${`${API_ROOT}/epigraphs`}"
                        link="true"
                      ></sc-text-carousel>
                    </div>
                  </div>
          ...
          <div class="row cards">
            <paper-card
              class="two-paper-cards paper-cards-no-background first-card transparent-card"
              elevation="2"
              image="/img/home-page/returninghome.jpg"
              alt="${_`What’s here`}"
            >
              <div class="transparent-card-content-wrapper">
                <div class="card-title-text">${_`What’s here`}</div>
            ...
            <paper-card
              class="two-paper-cards paper-cards-no-background second-card transparent-card"
              elevation="2"
              image="/img/home-page/contemplatingthemoon.jpg"
              alt="${_`Where to begin`}"
            >
              <div class="transparent-card-content-wrapper">
                <div class="card-title-text">${_`Where to begin`}</div>
                <div class="image-card-text">
          ...
          <div class="row">
            <div class="big-card-title">${_`Tipiṭaka—the three baskets`}</div>
            <div class="three-elements-grid">
              <paper-card
                alt="${_`Sixteen gilt and lacquer leaves with two gilt and lacquer book covers. Wood coated with lacquer, \n                        twelve lines to each leaf written in Pali script in black lacquer, the text interspersed and bordered \n                        with undulating floral and vegetal motifs in gold on an orange ground. Burma, 19th century. 16 x 63 cm.`}"
                class="three-elements-big paper-card-with-button"
                elevation="2"
                image="/img/home-page/burmese_kammavaca.jpg"
                title="${_`A decorative kammavaca manuscript`}"
              >
                <div class="card-content-wrapper no-bottom-padding">
                  <div class="card-title-text">${_`Discourses`}</div>
                  <div class="image-card-text">
              ...
              <paper-card
                class="three-elements-small three-elements-first-small full-height paper-card-with-button"
                elevation="2"
              >
                <div class="card-content-wrapper no-bottom-padding">
                  <div class="card-title-text">${_`Monastic Law`}</div>
              ...
              <paper-card
                class="three-elements-small three-elements-second-small full-height paper-card-with-button"
                elevation="2"
              >
                <div class="card-content-wrapper no-bottom-padding">
                  <div class="card-title-text">${_`Abhidhamma`}</div>
                  <div class="image-card-text">
                ...
                <div class="card-content">
                  <div class="card-content-text">
                    <div class="why-we-read">
                      <sc-text-carousel
                        .elementsUrl="${`${API_ROOT}/whyweread`}"
                      ></sc-text-carousel>
                    </div>
                  </div>
                </div>
          ...
          <div class="row cards">
            <paper-card
              class="two-paper-cards first-card paper-card-with-button"
              elevation="2"
              image="/img/home-page/noword.jpg"
              alt="${_`A Reader’s Guide to the Pali Suttas`}"
            >
              <div class="card-content-wrapper">
                <div class="card-title-text">${_`A Reader’s Guide to the Pali Suttas`}</div>
                <div class="image-card-text">
            ...
            <paper-card
              class="two-paper-cards second-card paper-card-with-button"
              elevation="2"
              image="/img/home-page/listeningtotherain.jpg"
              alt="${_`Indexes and Terminology`}"
            >
              <div class="card-content-wrapper">
                <div class="card-title-text">${_`Indexes and Terminology`}</div>
                <div class="image-card-text">

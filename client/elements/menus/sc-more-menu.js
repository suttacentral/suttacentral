...
class SCMoreMenu extends LitLocalized(LitElement) {
    ...
    _renderMoreMenu() {
        return html`
            <mwc-list-item class="more-menu-mwc-list-item language-choice-box" @click="${this._showLanguageMenu}">
                <div class="menu-item-wrapper">
                    <iron-icon class="more-menu-icon" icon="sc-iron-icons:language"></iron-icon>
                    <div id="language-wrapper">
                        <span id="language-text-wrapper">
                            ${this._displayCurrentSiteLanguage()}
                        </span>
